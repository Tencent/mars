...
Mars is a cross-platform infrastructure component that developed by the WeChat Mobile DevTeam. 
...
Start with example usage [here](https://github.com/Tencent/mars/wiki/Mars-sample-%E4%BD%BF%E7%94%A8%E8%AF%B4%E6%98%8E)
...
You can choose [mars-wrapper](#wrapper) or [mars-core](#core). We recommend you to use mars-wrapper when only sample is needed, while mars-core is preferred to be used in your app. 
...
```xml
dependencies {
    compile 'com.tencent.mars:mars-wrapper:1.1.2'
}
```
...
```xml
dependencies {
    compile 'com.tencent.mars:mars-core:1.1.2'
}
```
...
When multiple processes is used in your app, make sure that each process owns its exckusive log file.
...
```
*********
If you add dependencies of mars-core to your project, you need initialize and uninitialize STN.  
...
```
**********
If you add dependencies of mars-wrapper to your project, you just need initialize STN and no need uninitialize.
...
Uninitialize xlog in function "applicationWillTerminate"
...
If you want to destory STN or exit App:
...
example 的使用请参考[这里](https://github.com/Tencent/mars/wiki/Mars-sample-%E4%BD%BF%E7%94%A8%E8%AF%B4%E6%98%8E)
...
gradle 接入我们提供了两种接入方式：[mars-wrapper](#wrapper) 或者 [mars-core](#core)。如果你只是想做个 sample 的话推荐使用 mars-wrapper，可以快速开发；但是如果你想把 mars 用到你的 app 中的话，推荐使用 mars-core，可定制性更高。
