 ...
 **/
@interface MessagepushRoot : GPBRootObject
@end

#pragma mark - MessagePush

typedef GPB_ENUM(MessagePush_FieldNumber) {
  MessagePush_FieldNumber_Topic = 1,
  MessagePush_FieldNumber_Content = 2,
  MessagePush_FieldNumber_From = 3,
};

@interface MessagePush : GPBMessage
