...
LRESULT CMainDlg::OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
    ...
    HWND hChildWnd = CreateDialogParam(_Module.GetResourceInstance(), MAKEINTRESOURCE(IDD_DIALOGPINGSERVER), hTabCtrl,
    NULL, 0);
    ::ShowWindow(hChildWnd, SW_SHOWDEFAULT);*/

    // HWND hChildWnd = CreateDialogParam(_Module.GetResourceInstance(), MAKEINTRESOURCE(IDD_DIALOGPINGSERVER),
    // hTabCtrl, NULL, 0); ShowWindow(hChildWnd, SW_SHOWDEFAULT);
