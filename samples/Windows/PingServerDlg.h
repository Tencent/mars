...
class CMainDlg;
class CPingServerDlg : public CDialogImpl<CPingServerDlg>,
                       public CUpdateUI<CPingServerDlg>,
                       public CMessageFilter,
                       public CIdleHandler,
                       public boost::enable_shared_from_this<CPingServerDlg>,
                       public HelloCGICallback,
                       public GetConvListCGICallback {
 public:
    ...
    virtual void OnResponse(GetConvListCGITask* task,
