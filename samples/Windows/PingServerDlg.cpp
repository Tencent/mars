...
#include "MainDlg.h"
#include "stdafx.h"
CPingServerDlg::CPingServerDlg() : m_host(nullptr) {
}
...
LRESULT CPingServerDlg::OnBnClickedBtnchatroom(WORD /*wNotifyCode*/,
                                               WORD /*wID*/,
                                               HWND /*hWndCtl*/,
                                               BOOL& /*bHandled*/) {
...
void CPingServerDlg::OnResponse(GetConvListCGITask* task,
                                const com::tencent::mars::sample::proto::ConversationListResponse& response) {
    ...
    if (m_host)
        m_host->PostMessage(WM_GETCONVERSATIONLIST, (WPARAM)conversationList);
}
