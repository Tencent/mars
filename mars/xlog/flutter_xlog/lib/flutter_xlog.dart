...
///
///  A enum class to illustrate the level of one log item.
///
...
class XLogConfig {
  ...
  ///
  /// **level** use to filter log records to write into file
  ///
  /// **cacheDir** illustrate the directory to save log cache file (.mmap)
  ///
  /// **logDir** illustrate the directory to save xlog file (.xlog)
  ///
  /// **namePrefix** will be used to name xlog file with it as prefix
  ///
  /// **cacheDays** illustrate the num of days to save the log cache file, normally you need not set it
  ///
  /// **consoleLogOpen** should be set *true* if you also need print log to console
  ///
  /// **pubKey** illustrate the public key that will be used to encrypt log records
  ///
  XLogConfig(
