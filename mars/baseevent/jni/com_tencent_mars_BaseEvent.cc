...
JNIEXPORT void JNICALL Java_com_tencent_mars_BaseEvent_onInit(JNIEnv* env, jclass, jint _packer_encoder_version) {
    mars::baseevent::OnInit(_packer_encoder_version);
}
