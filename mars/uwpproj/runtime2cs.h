...
public
ref struct AccountInfoRet sealed {
    property uint64 uin;
    property Platform::String ^ username;
};

public
ref struct DeviceInfoRet sealed {
    property Platform::String ^ devicename;
    property Platform::String ^ devicetype;
};

public
ref struct Req2BufRet sealed {
...
public
ref struct Buf2RespRet sealed {
    property int bRet;
    property int nErrCode;
};

public
ref struct Buf2RespArg sealed {
    property int taskid;
...
public
enum class LonglinkCheckType { ECHECK_NOW = 0, ECHECK_NEXT = 1, ECHECK_NEVER = 2 };
public
ref struct GetLonglinkIdentifyRet sealed {
...
public
ref struct CurRadioAccessNetworkInfo sealed { property Platform::String ^ radio_access_network; };

public
ref struct CurSIMInfo sealed {
    property Platform::String ^ isp_code;
    property Platform::String ^ isp_name;
};

public
ref struct CurAPNInfo sealed {
...
interface class ICallback_Comm {
    ...
    Buf2RespRet
        ^ Buf2Resp(int taskid,
                   int user_context,
                   const Platform::Array<uint8> ^ inbuffer,
                   int error_code,
                   int channel_select);
    //任务执行结束
    ...
    //长连信令校验回包
    bool OnLonglinkIdentifyResponse(const Platform::Array<uint8> ^ response_buffer,
                                    const Platform::Array<uint8> ^ identify_buffer_hash);
