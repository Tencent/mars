...
public
ref class MarsRuntimeComponent sealed {
 public:
...
ref class StnComponent sealed {
 public:
    ...
    static void SetLonglinkSvrAddr(Platform::String ^ host,
                                   const Platform::Array<uint16> ^ ports,
                                   Platform::String ^ debugip);
...
public
ref struct LogGetPathRet sealed {
    property Platform::String ^ logPath;
    property bool bRet;
};

public
enum class TAppenderModeRuntime { kAppenderAsync = 0, kAppednerSync = 1 };

public
enum class TLogLevelRuntime {
    kLevelAll = 0,
    kLevelVerbose = 0,
...
public
ref class LogComponent sealed {
 public:
    static void AppenderOpen(TAppenderModeRuntime _mode, Platform::String ^ _dir, Platform::String ^ _nameprefix);
    static void AppenderOpenWithCache(TAppenderModeRuntime _mode,
                                      Platform::String ^ _cachedir,
                                      Platform::String ^ _logdir,
                                      Platform::String ^ _nameprefix);
    ...
    static bool AppenderGetFilePathFromTimeSpan(int _timespan,
                                                Platform::String ^ _prefix,
                                                const Platform::Array<Platform::String ^> ^ _filepath_vec);
    ...
    static void LogWrite(TLogLevelRuntime _level,
                         Platform::String ^ _tag,
                         Platform::String ^ _filename,
                         Platform::String ^ _funcname,
                         int _line,
                         intmax_t _pid,
                         intmax_t _tid,
                         intmax_t _maintid,
                         Platform::String ^ _log);
};
#pragma endregion

#pragma region sdt
public
ref class SdtComponent sealed {
 public:
