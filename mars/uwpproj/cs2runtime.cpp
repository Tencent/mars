...
void mars::StnComponent::SetLonglinkSvrAddr(Platform::String ^ host,
...
void mars::LogComponent::AppenderOpen(TAppenderModeRuntime _mode,
                                      Platform::String ^ _dir,
...
void mars::LogComponent::AppenderOpenWithCache(TAppenderModeRuntime _mode,
...
bool mars::LogComponent::AppenderGetFilePathFromTimeSpan(int _timespan,
...
void mars::LogComponent::LogWrite(TLogLevelRuntime _level,
