...
COMM_COPY_HEADER_FILES = {"mars/mars/comm/verinfo.h": "comm",
            ...
            "mars/mars/openssl/export_include/aes_crypt.h": "openssl",
            "mars/mars/openssl/export_include/md5_digest.h": "openssl",
            "mars/mars/openssl/export_include/rsa_crypt.h": "openssl",
