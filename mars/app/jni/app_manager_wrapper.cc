...
class JniAppManager {
 public:
    static void JniOnCreate(JNIEnv* env, jobject instance, jlong handle) {
    ...
    static void JniOnDestroy(JNIEnv* env, jobject instance) {
...
static const JNINativeMethod kAppManagerJniMethods[] = {
    {"OnJniCreate", "(J)V", (void*)&mars::app::JniAppManager::JniOnCreate},
    {"OnJniOnDestroy", "()V", (void*)&mars::app::JniAppManager::JniOnDestroy},
    {"OnJniSetCallback", "(Lcom/tencent/mars/app/AppManager$CallBack;)V", (void*)&mars::app::JniAppManager::JniSetCallback},
};
