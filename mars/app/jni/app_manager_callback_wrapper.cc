...
JNICAT_DEFINE_METHOD(kAppManagerJniCallback_GetAppFilePath,
...
JNICAT_DEFINE_METHOD(kAppManagerJniCallback_GetClientVersion,
                     "com/tencent/mars/app/AppManager$CallBack",
                     "getClientVersion",
                     "()I")
...
JNICAT_DEFINE_METHOD(kAppManagerJniCallback_GetDeviceInfo,
                     "com/tencent/mars/app/AppManager$CallBack",
                     "getDeviceType",
...
DeviceInfo AppManagerJniCallback::GetDeviceInfo() {
    jnienv_ptr env;
    DeviceInfo info;
    jobject ret_obj = c2j_call(jobject, callback_inst_, kAppManagerJniCallback_GetDeviceInfo);
