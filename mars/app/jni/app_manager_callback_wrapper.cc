...
JNICAT_DEFINE_METHOD(kAppManagerJniCallback_GetDeviceInfo, "com/tencent/mars/app/AppManager$CallBack", "getDeviceType", "()Lcom/tencent/mars/app/AppLogic$DeviceInfo;")
