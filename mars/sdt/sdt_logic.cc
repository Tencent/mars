...
//static SdtManager* sg_sdt_manager = (SdtManager*)mars::boot::CreateContext("default")->GetManager("Sdt");
//static SdtManager* sg_sdt_manager = (SdtManager*)mars::boot::g_fun_create_context("default")->GetManager("Sdt");
