...
class BaseNetInfo {
 public:
    ...
    TLocalIPStack ip_stack() const {
        return ip_stack_;
    }
    std::string detail_nettype_info() const {
        return detail_nettype_info_;
    }
    std::string ipstack_detect_info() const {
        return ipstack_detect_info_;
    }
    std::string net_gateway_info() const {
        return net_gateway_info_;
    }
    std::string net_dnssvr_info() const {
        return net_dnssvr_info_;
    }
    std::string net_interface_info() const {
        return net_dnssvr_info_;
    }
    std::string route_info() const {
        return route_info_;
    }
