...
LOCAL_CFLAGS += -Wsign-compare -Wtype-limits -Wuninitialized -Wunused-parameter -Wempty-body #-Wextra 64bit
LOCAL_CFLAGS += -Wno-error=conversion -Wno-error=sign-conversion -Werror=sign-compare -Wno-error=format -Wno-error=pointer-to-int-cast -Wno-char-subscripts -Wno-gnu-designator
LOCAL_CFLAGS += -Wno-unused-parameter -Wno-missing-field-initializers -Wno-error=unused-variable -Wno-mismatched-tags
