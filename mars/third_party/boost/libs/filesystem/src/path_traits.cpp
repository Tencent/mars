...
// define BOOST_FILESYSTEM_SOURCE so that <third_party/boost/system/config.hpp> knows
...
#include <third_party/boost/filesystem/path_traits.hpp>
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace filesystem { namespace path_traits {
