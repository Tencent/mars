...
// Define BOOST_IOSTREAMS_SOURCE so that <third_party/boost/iostreams/detail/config.hpp>
...
#include <third_party/boost/config.hpp>                       // BOOST_JOIN
#include <third_party/boost/iostreams/detail/error.hpp>
#include <third_party/boost/iostreams/detail/config/dyn_link.hpp>
#include <third_party/boost/iostreams/detail/config/rtl.hpp>  // BOOST_IOSTREAMS_FD_XXX
#include <third_party/boost/iostreams/detail/config/windows_posix.hpp>
#include <third_party/boost/iostreams/detail/system_failure.hpp>
#include <third_party/boost/iostreams/detail/ios.hpp>         // openmodes, failure.
#include <third_party/boost/iostreams/device/file_descriptor.hpp>
