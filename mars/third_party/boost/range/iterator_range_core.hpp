...
#include <third_party/boost/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <third_party/boost/type_traits/is_base_and_derived.hpp>
...
#include <third_party/boost/range/functions.hpp>
...
#include <third_party/boost/range/detail/safe_bool.hpp>
