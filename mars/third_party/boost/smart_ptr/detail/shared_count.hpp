...
#include <third_party/boost/smart_ptr/bad_weak_ptr.hpp>
#include <third_party/boost/smart_ptr/detail/sp_counted_base.hpp>
#include <third_party/boost/smart_ptr/detail/sp_counted_impl.hpp>
