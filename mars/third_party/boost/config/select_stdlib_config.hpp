...
// libc++
#  define BOOST_STDLIB_CONFIG "third_party/boost/config/stdlib/libcpp.hpp"
...
//
#  include "third_party/boost/config/stdlib/stlport.hpp"
#  include "third_party/boost/config/stdlib/libcomo.hpp"
#  include "third_party/boost/config/stdlib/roguewave.hpp"
#  include "third_party/boost/config/stdlib/libcpp.hpp"
#  include "third_party/boost/config/stdlib/libstdcpp3.hpp"
#  include "third_party/boost/config/stdlib/sgi.hpp"
#  include "third_party/boost/config/stdlib/msl.hpp"
#  include "third_party/boost/config/stdlib/vacpp.hpp"
#  include "third_party/boost/config/stdlib/modena.hpp"
#  include "third_party/boost/config/stdlib/dinkumware.hpp"
#endif
