...
// Boost type traits:
#include <third_party/boost/math/tools/config.hpp>
#include <third_party/boost/type_traits/is_floating_point.hpp> // for mars_boost::is_floating_point;
#include <third_party/boost/type_traits/is_integral.hpp> // for mars_boost::is_integral
#include <third_party/boost/type_traits/is_convertible.hpp> // for mars_boost::is_convertible
#include <third_party/boost/type_traits/is_same.hpp>// for mars_boost::is_same
#include <third_party/boost/type_traits/remove_cv.hpp>// for mars_boost::remove_cv
// Boost Template meta programming:
#include <third_party/boost/mpl/if.hpp> // for mars_boost::mpl::if_c.
#include <third_party/boost/mpl/and.hpp> // for mars_boost::mpl::if_c.
#include <third_party/boost/mpl/or.hpp> // for mars_boost::mpl::if_c.
#include <third_party/boost/mpl/not.hpp> // for mars_boost::mpl::if_c.
