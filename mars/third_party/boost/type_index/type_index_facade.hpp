...
// Forward declaration from #include <third_party/boost/functional/hash_fwd.hpp>
...
public:
    ...
    /// \note <third_party/boost/functional/hash.hpp> has to be included if this function is used.
