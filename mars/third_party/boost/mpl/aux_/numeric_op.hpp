...
#   include <third_party/boost/mpl/numeric_cast.hpp>
#   include <third_party/boost/mpl/apply_wrap.hpp>
#   include <third_party/boost/mpl/if.hpp>
#   include <third_party/boost/mpl/tag.hpp>
#   include <third_party/boost/mpl/aux_/numeric_cast_utils.hpp>
...
#   include <third_party/boost/mpl/aux_/msvc_eti_base.hpp>
#   include <third_party/boost/mpl/aux_/value_wknd.hpp>
#   include <third_party/boost/mpl/aux_/config/eti.hpp>
...
#   include <third_party/boost/mpl/aux_/preprocessor/sub.hpp>
#   include <third_party/boost/mpl/aux_/config/ctps.hpp>
#   include <third_party/boost/mpl/aux_/config/eti.hpp>
#   include <third_party/boost/mpl/aux_/config/msvc.hpp>
#   include <third_party/boost/mpl/aux_/config/workaround.hpp>

#   include <third_party/boost/preprocessor/dec.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,( BOOST_PP_DEC(AUX778076_OP_ARITY), 2, <third_party/boost/mpl/aux_/numeric_op.hpp> ))
