...
#   include <third_party/boost/mpl/limits/vector.hpp>
...
#   include BOOST_PP_STRINGIZE(third_party/boost/mpl/vector/AUX778076_VECTOR_HEADER)
...
#   include <third_party/boost/mpl/aux_/sequence_wrapper.hpp>
