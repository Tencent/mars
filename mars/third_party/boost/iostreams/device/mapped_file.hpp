...
#include <third_party/boost/config.hpp>                   // make sure size_t is in std.
#include <cstddef>                            // size_t.
#include <string>                             // pathnames.
#include <utility>                            // pair.
#include <third_party/boost/config.hpp>                   // BOOST_MSVC.
#include <third_party/boost/detail/workaround.hpp>
#include <third_party/boost/iostreams/close.hpp>
#include <third_party/boost/iostreams/concepts.hpp>
#include <third_party/boost/iostreams/detail/config/auto_link.hpp>
#include <third_party/boost/iostreams/detail/config/dyn_link.hpp>
#include <third_party/boost/iostreams/detail/config/wide_streams.hpp>
#include <third_party/boost/iostreams/detail/ios.hpp>     // openmode, failure
#include <third_party/boost/iostreams/detail/path.hpp>
#include <third_party/boost/iostreams/operations_fwd.hpp>
#include <third_party/boost/iostreams/positioning.hpp>
...
#include <third_party/boost/config/abi_suffix.hpp> // pops abi_suffix.hpp pragmas
