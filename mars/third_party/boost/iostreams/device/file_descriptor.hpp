...
#include <string>
#include <third_party/boost/cstdint.hpp>               // intmax_t.
#include <third_party/boost/iostreams/categories.hpp>  // tags.
...
#include <third_party/boost/iostreams/detail/file_handle.hpp>
#include <third_party/boost/iostreams/detail/ios.hpp>  // openmode, seekdir, int types.
