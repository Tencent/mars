...
#include <new>          
#include <third_party/boost/config.hpp>  // MSVC, STATIC_CONSTANT, DEDUCED_TYPENAME, DINKUM.
#include <third_party/boost/cstdint.hpp> // uint*_t
...
#include <third_party/boost/iostreams/detail/config/zlib.hpp>
#include <third_party/boost/iostreams/detail/ios.hpp>  // failure, streamsize.
#include <third_party/boost/iostreams/filter/symmetric.hpp>
