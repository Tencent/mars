...
#include <third_party/boost/config.hpp>                     // BOOST_DEDUCED_TYPENAME.
#include <third_party/boost/iostreams/char_traits.hpp>
#include <third_party/boost/iostreams/constants.hpp>        // buffer size.
#include <third_party/boost/iostreams/detail/buffer.hpp>
#include <third_party/boost/iostreams/detail/char_traits.hpp>
#include <third_party/boost/iostreams/detail/config/limits.hpp>
#include <third_party/boost/iostreams/detail/template_params.hpp>
#include <third_party/boost/iostreams/traits.hpp>
#include <third_party/boost/iostreams/operations.hpp>       // read, write.
#include <third_party/boost/iostreams/pipeline.hpp>
#include <third_party/boost/preprocessor/iteration/local.hpp>
#include <third_party/boost/preprocessor/punctuation/comma_if.hpp>
...
// Must come last.
#include <third_party/boost/iostreams/detail/config/disable_warnings.hpp>  // MSVC.
...
#include <third_party/boost/iostreams/detail/config/enable_warnings.hpp>  // MSVC.
