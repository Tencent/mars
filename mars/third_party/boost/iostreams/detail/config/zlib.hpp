...
// Adapted from <third_party/boost/config/auto_link.hpp> and from
...
#include <third_party/boost/config.hpp> // BOOST_STRINGIZE.
...
#  define BOOST_LIB_NAME mars_boost_zlib
...
#  include <third_party/boost/config/auto_link.hpp>
# endif
#endif
