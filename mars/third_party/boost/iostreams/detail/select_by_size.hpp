...
//    #include <third_party/boost/utility/select_by_size.hpp>
//
...
#include <third_party/boost/config.hpp>    // BOOST_STATIC_CONSTANT.
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace utility {
