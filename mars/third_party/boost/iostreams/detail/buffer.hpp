...
#include <third_party/boost/config.hpp>                    // member templates.
...
#include <third_party/boost/iostreams/traits.hpp>          // int_type_of.
#include <third_party/boost/iostreams/checked_operations.hpp>
