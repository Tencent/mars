...
#include <third_party/boost/config.hpp>                             // SFINAE, MSVC.
#include <third_party/boost/detail/workaround.hpp>
#include <third_party/boost/iostreams/detail/enable_if_stream.hpp>
#include <third_party/boost/iostreams/traits_fwd.hpp>               // is_std_io.
