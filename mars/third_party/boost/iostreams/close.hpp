...
#include <third_party/boost/config.hpp>  // DEDUCED_TYPENAME, MSVC.
#include <third_party/boost/detail/workaround.hpp>
#include <third_party/boost/iostreams/categories.hpp>
#include <third_party/boost/iostreams/flush.hpp>
#include <third_party/boost/iostreams/detail/adapter/non_blocking_adapter.hpp>
#include <third_party/boost/iostreams/detail/ios.hpp> // BOOST_IOS
#include <third_party/boost/iostreams/detail/select.hpp>
#include <third_party/boost/iostreams/detail/wrap_unwrap.hpp>
#include <third_party/boost/iostreams/operations_fwd.hpp>
#include <third_party/boost/iostreams/traits.hpp>
#include <third_party/boost/mpl/identity.hpp>
#include <third_party/boost/mpl/if.hpp>
#include <third_party/boost/type_traits/is_convertible.hpp>
#include <third_party/boost/type_traits/is_integral.hpp>
...
// Must come last.
#include <third_party/boost/iostreams/detail/config/disable_warnings.hpp>
...
# include <third_party/boost/iostreams/detail/vc6/close.hpp>
...
#include <third_party/boost/iostreams/detail/config/enable_warnings.hpp>
