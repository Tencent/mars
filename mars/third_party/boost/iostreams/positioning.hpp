...
#include <third_party/boost/iostreams/detail/config/codecvt.hpp> // mbstate_t.
#include <third_party/boost/iostreams/detail/config/fpos.hpp>
#include <third_party/boost/iostreams/detail/ios.hpp> // streamoff, streampos.
