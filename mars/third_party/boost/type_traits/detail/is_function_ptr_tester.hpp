...
//
#define PP1 <third_party/boost/preprocessor/iterate.hpp>
#define PP2 <third_party/boost/preprocessor/enum_params.hpp>
#define PP3 <third_party/boost/preprocessor/comma_if.hpp>
#include PP1
#include PP2
#include PP3
#undef PP1
