...
//
#define PPI <third_party/boost/preprocessor/iterate.hpp>
#include PPI
#undef PPI
#define PPI <third_party/boost/preprocessor/enum_params.hpp>
#include PPI
#undef PPI
#define <third_party/boost/preprocessor/comma_if.hpp>
#include PPI
#undef
#endif
