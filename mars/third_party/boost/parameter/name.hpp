...
# include <third_party/boost/parameter/keyword.hpp>
# include <third_party/boost/parameter/value_type.hpp>
...
#  define BOOST_PARAMETER_IS_BINARY_C(x,y) \
    ...
    /**/
# else
#  include <third_party/boost/preprocessor/detail/is_binary.hpp>
