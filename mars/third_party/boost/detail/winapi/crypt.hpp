...
#include <third_party/boost/detail/winapi/detail/cast_ptr.hpp>
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace detail { namespace winapi {
