...
# include <third_party/boost/concept/detail/backward_compatibility.hpp>

# ifdef BOOST_OLD_CONCEPT_SUPPORT
#  include <third_party/boost/concept/detail/has_constraints.hpp>
#  include <third_party/boost/mpl/if.hpp>
# endif

// This implementation works on Comeau and GCC, all the way back to
// 2.95
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace concepts {
