...
#include <third_party/boost/core/noncopyable.hpp>
#include <third_party/boost/uuid/sha1.hpp>
//#include <third_party/boost/nondet_random.hpp> //forward declare mars_boost::random::random_device

// can't use mars_boost::generator_iterator since mars_boost::random number seed(Iter&, Iter)
// functions need a last iterator
//#include <third_party/boost/generator_iterator.hpp>
...
#   include <third_party/boost/detail/winapi/crypt.hpp> // for CryptAcquireContextA, CryptGenRandom, CryptReleaseContext
#   include <third_party/boost/detail/winapi/timers.hpp>
#   include <third_party/boost/detail/winapi/process.hpp>
#   include <third_party/boost/detail/winapi/thread.hpp>
#else 
