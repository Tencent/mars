...
#include <pthread.h>
#include <third_party/boost/thread/cv_status.hpp>
...
#include <third_party/boost/thread/xtime.hpp>
#endif
...
#include <third_party/boost/date_time/posix_time/posix_time_duration.hpp>
    ...
    public:
      BOOST_THREAD_NO_COPYABLE(condition_variable)
        condition_variable()
        {
            ...
            if(res)
            {
                mars_boost::throw_exception(thread_resource_error(res, "boost::condition_variable::condition_variable() constructor failed in pthread_mutex_init"));
            }
#endif
...
#endif
                mars_boost::throw_exception(thread_resource_error(res, "boost::condition_variable::condition_variable() constructor failed in detail::monotonic_pthread_cond_init"));
            }
        }
        ~condition_variable()
        {
