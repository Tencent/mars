...
#include <third_party/boost/config/requires_threads.hpp>

// choose platform
#if defined(linux) || defined(__linux) || defined(__linux__)
#  define BOOST_THREAD_LINUX
//#  define BOOST_THREAD_WAIT_BUG mars_boost::posix_time::microseconds(100000)
...
//#  define BOOST_THREAD_WAIT_BUG mars_boost::posix_time::microseconds(1000)
