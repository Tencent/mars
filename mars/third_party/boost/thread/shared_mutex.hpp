...
#include <third_party/boost/thread/pthread/shared_mutex.hpp>
#else
#include <third_party/boost/thread/win32/shared_mutex.hpp>
#endif
#elif defined(BOOST_THREAD_PLATFORM_PTHREAD)
//#include <third_party/boost/thread/v2/shared_mutex.hpp>
#include <third_party/boost/thread/pthread/shared_mutex.hpp>
#else
