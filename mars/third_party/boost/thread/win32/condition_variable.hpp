...
#include <third_party/boost/thread/win32/thread_primitives.hpp>
#include <third_party/boost/thread/win32/thread_data.hpp>
#include <third_party/boost/thread/win32/thread_data.hpp>
#include <third_party/boost/thread/win32/interlocked_read.hpp>
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost
{
    namespace detail
    {
        ...
        class basic_condition_variable
        {
            ...
            {
                mars_boost::lock_guard<boost::mutex> internal_lock(internal_mutex);
