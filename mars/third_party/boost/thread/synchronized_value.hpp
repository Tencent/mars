...
#include <third_party/boost/thread/lock_guard.hpp>
#include <third_party/boost/thread/lock_algorithms.hpp>
#include <third_party/boost/thread/lock_factories.hpp>
#include <third_party/boost/thread/strict_lock.hpp>
#include <third_party/boost/core/swap.hpp>
#include <third_party/boost/utility/declval.hpp>
//#include <third_party/boost/type_traits.hpp>
//#include <third_party/boost/thread/detail/is_nothrow_default_constructible.hpp>
//#if ! defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
//#include <type_traits>
//#endif

#if ! defined(BOOST_THREAD_NO_SYNCHRONIZE)
#include <tuple> // todo change to <third_party/boost/tuple.hpp> once Boost.Tuple or Boost.Fusion provides Move semantics on C++98 compilers.
#include <functional>
#endif
