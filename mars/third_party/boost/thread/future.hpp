...
#include <third_party/boost/thread/detail/invoker.hpp>
#include <third_party/boost/thread/detail/invoke.hpp>
#include <third_party/boost/thread/detail/is_convertible.hpp>
#include <third_party/boost/thread/exceptional_ptr.hpp>
#include <third_party/boost/thread/futures/future_error.hpp>
#include <third_party/boost/thread/futures/future_error_code.hpp>
#include <third_party/boost/thread/futures/future_status.hpp>
#include <third_party/boost/thread/futures/is_future_type.hpp>
#include <third_party/boost/thread/futures/launch.hpp>
#include <third_party/boost/thread/futures/wait_for_all.hpp>
#include <third_party/boost/thread/futures/wait_for_any.hpp>
#include <third_party/boost/thread/lock_algorithms.hpp>
#include <third_party/boost/thread/lock_types.hpp>
#include <third_party/boost/thread/mutex.hpp>
#include <third_party/boost/thread/thread_only.hpp>
#include <third_party/boost/thread/thread_time.hpp>
#include <third_party/boost/thread/executor.hpp>
#include <third_party/boost/thread/executors/generic_executor_ref.hpp>

#if defined BOOST_THREAD_FUTURE_USES_OPTIONAL
#include <third_party/boost/optional.hpp>
#else
...
#include <third_party/boost/chrono/system_clocks.hpp>
#endif
#include <third_party/boost/core/enable_if.hpp>
#include <third_party/boost/core/ref.hpp>
...
#include <third_party/boost/type_traits/conditional.hpp>
#include <third_party/boost/type_traits/decay.hpp>
#include <third_party/boost/type_traits/is_copy_constructible.hpp>
#include <third_party/boost/type_traits/is_fundamental.hpp>
#include <third_party/boost/type_traits/is_void.hpp>
#include <third_party/boost/utility/result_of.hpp>


#if defined BOOST_THREAD_PROVIDES_FUTURE_CTOR_ALLOCATORS
#include <third_party/boost/thread/detail/memory.hpp>
#include <third_party/boost/container/scoped_allocator.hpp>
...
#include <third_party/boost/thread/csbl/tuple.hpp>
#include <third_party/boost/thread/csbl/vector.hpp>
#endif
...
#include <third_party/boost/detail/atomic_undef_macros.hpp>
          if(!atomic_load(&future_))
            {
                future_ptr blank;
                atomic_compare_exchange(&future_,&blank,future_ptr(new detail::shared_state<R>));
            }
#include <third_party/boost/detail/atomic_redef_macros.hpp>
#endif
        }
