...
#include <third_party/boost/algorithm/string/config.hpp>
#include <algorithm>
#include <iterator>
...
#include <third_party/boost/range/as_literal.hpp>

#include <third_party/boost/algorithm/string/concept.hpp>
#include <third_party/boost/algorithm/string/find_iterator.hpp>
#include <third_party/boost/algorithm/string/detail/util.hpp>
