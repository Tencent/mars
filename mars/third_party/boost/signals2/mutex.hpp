...
# include <third_party/boost/signals2/detail/lwm_nop.hpp>
#elif defined(BOOST_HAS_PTHREADS)
#  include <third_party/boost/signals2/detail/lwm_pthreads.hpp>
#elif defined(BOOST_HAS_WINTHREADS)
#  include <third_party/boost/signals2/detail/lwm_win32_cs.hpp>
#else
