...
namespace owl {
    ...
    public:
        ...
        Scope(Scope&& other) noexcept
            : Storage{ static_cast<Storage&&>(std::move(other)) } {
...
#define OWL_SCOPE_EXIT_WITH_ID(id) auto id = ::owl::detail::ScopeBuilder<::owl::AlwaysCall>{ ::owl::AlwaysCall{} } * [&]
#define OWL_SCOPE_FAIL_WITH_ID(id) auto id = ::owl::detail::ScopeBuilder<::owl::CallOnError>{ ::owl::CallOnError{} } * [&]
