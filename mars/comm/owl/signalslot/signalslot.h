...
#include "function.h"
#include "comm/owl/mpl/preprocessor.h"
#include "comm/owl/mpl/meta_function.h"
...
public:
	...
	void connect(char group, R (*fn)(Args...)) {
        assert(fn);
        function_type f(group, fn);
...
public:
	...
	void disconnect(char group) {
        signal_base::disconnect(group);
	}
