...
// descriptor: ()Z
DEFINE_FIND_STATIC_METHOD(KPlatformCommC2Java_isCellularNetworkActive,
                          KPlatformCommC2Java,
...
DEFINE_FIND_STATIC_METHOD(KPlatformCommC2Java_resolveHostByCellularNetwork,
                          KPlatformCommC2Java,
                          "resolveHostByCellularNetwork",
...
bool ResolveHostByCellularNetwork(const std::string& host, std::vector<std::string>& ips) {
    ...
    jstring ip_jstr = (jstring)JNU_CallStaticMethodByMethodInfo(env,
                                                                KPlatformCommC2Java_resolveHostByCellularNetwork,
                                                                host_jstr.GetJstr())
                          .l;
...
// descriptor: (I)Z
DEFINE_FIND_STATIC_METHOD(KPlatformCommC2Java_bindSocketToCellularNetwork,
                          KPlatformCommC2Java,
                          "bindSocketToCellularNetwork",
                          "(I)Z")
bool BindSocketToCellularNetwork(int socket_fd) {
    ...
    JNIEnv* env = scopeJEnv.GetEnv();
    jboolean ret =
        JNU_CallStaticMethodByMethodInfo(env, KPlatformCommC2Java_bindSocketToCellularNetwork, (jint)socket_fd).z;
