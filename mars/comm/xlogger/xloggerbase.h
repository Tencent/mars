...
extern intmax_t xlogger_pid(void);
extern intmax_t xlogger_tid(void);
extern intmax_t xlogger_maintid(void);
...
xlogger_filter_t xlogger_GetFilter(void);
