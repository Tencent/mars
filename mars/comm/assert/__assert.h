...
__attribute__((__nonnull__(1, 3, 4, 5))) __attribute__((__format__(printf, 5, 6))) void __ASSERT2(const char*,
                                                                                                  int,
                                                                                                  const char*,
                                                                                                  const char*,
                                                                                                  const char*,
                                                                                                  ...);
__attribute__((__nonnull__(1, 3, 4, 5))) __attribute__((__format__(printf, 5, 0))) void __ASSERTV2(const char*,
                                                                                                   int,
                                                                                                   const char*,
                                                                                                   const char*,
                                                                                                   const char*,
