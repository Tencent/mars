...
DEFINE_FIND_CLASS(KXlog, "com/tencent/luggage/xlog/Xlog")
...
DEFINE_FIND_METHOD(KXlog_newXlogInstance, KXlog, "newXlogInstance", "(Lcom/tencent/luggage/xlog/Xlog$XLogConfig;)J")
JNIEXPORT jlong JNICALL Java_com_tencent_luggage_xlog_Xlog_newXlogInstance
...
JNIEXPORT jlong JNICALL Java_com_tencent_luggage_xlog_Xlog_getXlogInstance
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_releaseXlogInstance
    (JNIEnv *env, jobject, jstring _nameprefix) {
    ScopedJstring nameprefix_jstr(env, _nameprefix);
    mars::xlog::ReleaseXloggerInstance(nameprefix_jstr.GetChar());
}

DEFINE_FIND_STATIC_METHOD(KXlog_appenderOpenWithMultipathWithLevel, KXlog, "appenderOpen", "(Lcom/tencent/luggage/xlog/Xlog$XLogConfig;)V")
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_appenderOpen
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_appenderClose(JNIEnv *env, jobject) {
    appender_close();
}

JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_appenderFlush(JNIEnv *env, jobject, jlong _log_instance_ptr, jboolean _is_sync) {
    CHECK_LOG_INSTANCE(_log_instance_ptr);
    mars::xlog::Flush(_log_instance_ptr, _is_sync);
}

DEFINE_FIND_STATIC_METHOD(KXlog_logWrite, KXlog, "logWrite", "(Lcom/tencent/luggage/xlog/Xlog$XLoggerInfo;Ljava/lang/String;)V")
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_logWrite
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_logWrite2
...
JNIEXPORT jint JNICALL Java_com_tencent_luggage_xlog_Xlog_getLogLevel
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_setLogLevel
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_setAppenderMode
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_setConsoleLogOpen
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_setMaxFileSize
...
JNIEXPORT void JNICALL Java_com_tencent_luggage_xlog_Xlog_setMaxAliveTime
