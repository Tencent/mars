...
DEFINE_FIND_CLASS(KXlog, "com/tencent/mars/ilink/xlog/Xlog")
...
JNIEXPORT void JNICALL Java_com_tencent_mars_ilink_xlog_Xlog_appenderFlush(JNIEnv *env, jobject, jboolean _is_sync) {
	if (_is_sync) {
		appender_flush_sync();
	} else {
		appender_flush();
...
DEFINE_FIND_STATIC_METHOD(KXlog_logWrite, KXlog, "logWrite", "(Lcom/tencent/mars/ilink/xlog/Xlog$XLoggerInfo;Ljava/lang/String;)V")
