...
const char* const LONGLINKTASKMANAGER_TEST_CMD[] = {
    "..\\stub\\echo.py -e AAAAEAAQAAE7msoGAAAAAA== -k 20000 --echo1 AAAAEAAQAAE7msoGAAAAAA==  --echo2 "
    "AAAAEAAQAAEAAAPpAAAAAQ== --length2 1 --period2 2000 127.0.0.100:8090",
    "..\\stub\\echo.py -e AAAAEAAQAAE7msoGAAAAAA== -k 20000 --echo1 AAAAEAAQAAE7msoGAAAAAA==  --echo2 "
    "AAAAEAAQAAEAAAPpAAAAAQ== --length2 1 --period2 2000 127.0.0.101:8091",
    "..\\stub\\echo.py -e AAAAEAAQAAE7msoGAAAAAA== -k 30000 --echo1 AAAAEAAQAAE7msoGAAAAAA==  --echo2 "
    "AAAAsAAQAAEAAAPpAAAAAgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    "AAAAAAA= --length2 16 --period2 4000 127.0.0.102:8092",
    "..\\stub\\echo.py -e AAAAEAAQAAE7msoGAAAAAA== -k 30000 --echo1 AAAAEAAQAAE7msoGAAAAAA==  --echo2 "
    "AAAAsAAQAAEAAAPpAAAAAgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    "AAAAAAA= --length2 16 --period2 4000 127.0.0.103:8093",
};
