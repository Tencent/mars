...
void StnManager::SetLongLink(const std::vector<std::string>& _hosts, const std::vector<uint16_t>& _ports, const std::string& _debugip) {
...
std::shared_ptr<NetCore> StnManager::GetNetCore() {
    return net_core_;
}
