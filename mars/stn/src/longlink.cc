...
LongLink::LongLink(BaseContext* _context, const mq::MessageQueue_t& _messagequeueid, NetSource& _netsource, const LonglinkConfig& _config, LongLinkEncoder& _encoder)
    : context_(_context)
...
SOCKET LongLink::__RunConnect(ConnectProfile& _conn_profile) {
    ...
    mars::comm::ProxyInfo proxy_info = context_->GetAppManager()->GetProxyInfo("");
