...
class SmartHeartbeat {
  public:
    boost::function<void (mars::boot::BaseContext* _context, TSmartHeartBeatAction _action, const NetHeartbeatInfo& _heart_info, bool _fail_timeout)> report_smart_heart_;
    
	SmartHeartbeat(mars::boot::BaseContext* _context);
	~SmartHeartbeat();
