...
ShortLinkInterface* (*Create)(boot::BaseContext* _context, const mq::MessageQueue_t& _messagequeueid, NetSource& _netsource, const Task& _task, const ShortlinkConfig& _config)
= [](boot::BaseContext* _context, const mq::MessageQueue_t& _messagequeueid, NetSource& _netsource, const Task& _task, const ShortlinkConfig& _config) -> ShortLinkInterface* {
...
LongLink* (*Create)(boot::BaseContext* _context, const mq::MessageQueue_t& _messagequeueid, NetSource& _netsource, const LonglinkConfig& _config)
= [](boot::BaseContext* _context, const mq::MessageQueue_t& _messagequeueid, NetSource& _netsource, const LonglinkConfig& _config) {
