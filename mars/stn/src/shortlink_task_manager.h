...
class ShortLinkTaskManager {
  ...
  public:
    ShortLinkTaskManager(boot::BaseContext* _context, mars::stn::NetSource& _netsource, DynamicTimeout& _dynamictimeout, comm::MessageQueue::MessageQueue_t _messagequeueid);
