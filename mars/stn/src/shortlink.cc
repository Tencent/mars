...
///////////////////////////////////////////////////////////////////////////////////////
ShortLink::ShortLink(boot::BaseContext* _context, MessageQueue::MessageQueue_t _messagequeueid, NetSource& _netsource, const Task& _task, bool _use_proxy, std::unique_ptr<SocketOperator> _operator)
    : context_(_context)
...
SOCKET ShortLink::__RunConnect(ConnectProfile& _conn_profile) {
    ...
    if (use_proxy_) {
        _conn_profile.proxy_info = context_->GetAppManager()->GetProxyInfo(_conn_profile.host);
    }
