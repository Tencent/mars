...
class JniStnManager {
 ...
 public:
    ...
    static void JniSetLonglinkSvrAddr(JNIEnv* env, jobject instance, jstring _host, jintArray _ports, jstring _debug_ip) {
        xverbose_function();
        auto stn_manager_cpp = jnicat::JniObjectWrapper<StnManager>::object(env, instance);
...
static const JNINativeMethod kStnManagerJniMethods[] = {
    ...
    //{"OnJniSetCallback", "(Lcom/tencent/mars/stn/StnManager$CallBack;)V", (void*)&mars::stn::JniStnManager::JniSetCallback},
    {"OnJniSetLonglinkSvrAddr", "(Ljava/lang/String;[ILjava/lang/String;)V", (void*)&mars::stn::JniStnManager::JniSetLonglinkSvrAddr},
    ...
    {"OnJniSetBackupIPs", "(Ljava/lang/String;[Ljava/lang/String;)V", (void*)&mars::stn::JniStnManager::JniSetBackupIPs},
