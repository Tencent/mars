...
class JniStnManager {
 public:
    ...
    static void JniResetAndInitEncoderVersion(JNIEnv* env,
                                              jobject instance,
        ...
        std::string packer_encoder_name =
            (NULL == _packer_encoder_name ? "" : ScopedJstring(env, _packer_encoder_name).GetChar());
...
static const JNINativeMethod kStnManagerJniMethods[] = {
    ...
    {"OnJniResetAndInitEncoderVersion",
     "(ILjava/lang/String;)V",
     (void*)&mars::stn::JniStnManager::JniResetAndInitEncoderVersion},
    {"OnJniSetBackupIPs",
