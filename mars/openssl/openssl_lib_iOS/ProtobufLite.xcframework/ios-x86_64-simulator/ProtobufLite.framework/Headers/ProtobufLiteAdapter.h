...
extern "C" {
#endif
	BOOL PBLite_ShouldLog(int level);
    void PBLite_LogWithinCommon(WTLogLevel log_level, const char *module, const char *file, int line, const char *funcname, NSString *message);
#ifdef __cplusplus
}
#endif
