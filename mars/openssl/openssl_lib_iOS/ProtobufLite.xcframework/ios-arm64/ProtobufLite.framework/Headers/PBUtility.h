 ...
 */
constexpr int32_t computeDoubleSizeNoTag() {
 ...
 */
constexpr int32_t computeFloatSizeNoTag() {
 ...
 */
constexpr int32_t computeFixed64SizeNoTag() {
    return LITTLE_ENDIAN_64_SIZE;
}
 ...
 */
constexpr int32_t computeFixed32SizeNoTag() {
    return LITTLE_ENDIAN_32_SIZE;
}
 ...
 */
constexpr int32_t computeBoolSizeNoTag() {
    return 1;
}
 ...
 */
constexpr int32_t computeSFixed32SizeNoTag() {
    return LITTLE_ENDIAN_32_SIZE;
}
 ...
 */
constexpr int32_t computeSFixed64SizeNoTag() {
    return LITTLE_ENDIAN_64_SIZE;
}
