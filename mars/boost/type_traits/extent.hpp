...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::mars_boost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::mars_boost::integral_constant<std::size_t, ::mars_boost::detail::extent_imp<T,N>::value>
{
};
