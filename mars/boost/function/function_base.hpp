...
#  define BOOST_FUNCTION_ENABLE_IF_NOT_INTEGRAL(Functor,Type)              \
      typename ::mars_boost::enable_if_<          \
    ...
    namespace function {
      ...
      union function_buffer_members
      {
        ...
        struct type_t {
          ...
          const mars_boost::core::typeinfo* type;
...
public:
  ...
  /** Retrieve the type of the stored function object, or type_id<void>()
      if this is empty. */
  const mars_boost::core::typeinfo& target_type() const
  {
  ...
  template<typename F>
    typename mars_boost::enable_if_< !mars_boost::is_function<F>::value, bool >::type
  ...
  template<typename Fn>
    typename mars_boost::enable_if_< mars_boost::is_function<Fn>::value, bool >::type
	contains(Fn& f) const
    {
      typedef Fn* F;
      if (const F* fp = this->template target<F>())
