...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace container { namespace dtl {
...
struct allocator_traits
{
   ...
   #else
      //pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(mars_boost::container::dtl::, Allocator,
         pointer, value_type*)
            pointer;
      //const_pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(mars_boost::container::dtl::, Allocator,
   ...
   {
      const bool value = mars_boost::container::dtl::
   ...
   select_on_container_copy_construction(const Allocator &a)
   {
      ...
      BOOST_CONTAINER_FORCEINLINE static void construct(Allocator & a, T* p, BOOST_FWD_REF(Args)... args)
      {
         static const bool value = ::mars_boost::move_detail::and_
            ...
            , mars_boost::container::dtl::has_member_function_callable_with_construct
                  < Allocator, T*, Args... >
            >::value;
         dtl::bool_<value> flag;
   ...
   template<class T>
   BOOST_CONTAINER_FORCEINLINE static void priv_construct(dtl::false_type, Allocator &, T *p, const ::mars_boost::container::default_init_t&)
