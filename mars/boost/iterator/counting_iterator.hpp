...
namespace detail
{
  ...
  struct is_numeric_impl
  {
      ...
      BOOST_STATIC_ASSERT(::mars_boost::is_integral<char>::value);
...
#  if !BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x551))
      BOOST_STATIC_CONSTANT(
          bool, value = (
              mars_boost::is_convertible<int,T>::value
           && mars_boost::is_convertible<T,int>::value
      ));
#  else
      BOOST_STATIC_CONSTANT(bool, value = ::mars_boost::is_arithmetic<T>::value);
#  endif
...
# endif
  ...
  template <class T>
  struct is_numeric
    : mars_boost::integral_constant<bool, ::mars_boost::iterators::detail::is_numeric_impl<T>::value>
  {};

#  if defined(BOOST_HAS_LONG_LONG)
  template <>
  struct is_numeric<mars_boost::long_long_type>
    : mars_boost::true_type {};

  template <>
  struct is_numeric<mars_boost::ulong_long_type>
    : mars_boost::true_type {};
#  endif

#  if defined(BOOST_HAS_INT128)
  template <>
  struct is_numeric<mars_boost::int128_type>
    : mars_boost::true_type {};

  template <>
  struct is_numeric<mars_boost::uint128_type>
    : mars_boost::true_type {};
#  endif
  ...
  {
      typedef typename mars_boost::detail::numeric_traits<T>::difference_type type;
  };

#  if defined(BOOST_HAS_INT128)
  // std::numeric_limits, which is used by numeric_traits, is not specialized for __int128 in some standard libraries
  template <>
  struct numeric_difference<mars_boost::int128_type>
  {
      typedef mars_boost::int128_type type;
  };

  template <>
  struct numeric_difference<mars_boost::uint128_type>
  {
      typedef mars_boost::int128_type type;
  };
#  endif
  ...
  struct counting_iterator_base
  {
      typedef typename detail::ia_dflt_help<
        ...
        , typename mars_boost::conditional<
            ...
            , mars_boost::type_identity<random_access_traversal_tag>
...
# endif
  ...
  struct number_distance
  {
      static Difference distance(Incrementable1 x, Incrementable2 y)
      {
          return mars_boost::detail::numeric_distance(x, y);
      }
  };
}
