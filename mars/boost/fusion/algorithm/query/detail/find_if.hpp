...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace fusion { namespace detail
{
    ...
    struct static_find_if
    {
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename mars_boost::disable_if<traits::is_random_access<Iterator>, type>::type
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename mars_boost::enable_if<traits::is_random_access<Iterator>, type>::type
        iter_call(Iterator const& iter)
        {
