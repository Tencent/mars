...
/// \brief Contains mars_boost::typeindex::ctti_type_index class that is constexpr if C++14 constexpr is supported by compiler.
///
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace typeindex {
...
public:
    ...
    BOOST_CXX14_CONSTEXPR inline ctti_type_index() noexcept
        : data_(mars_boost::detail::ctti<void>::n())
    {}
...
BOOST_CXX14_CONSTEXPR inline bool ctti_type_index::equal(const ctti_type_index& rhs) const noexcept {
    ...
    return /*left == right ||*/ !mars_boost::typeindex::detail::constexpr_strcmp(left, right);
}

BOOST_CXX14_CONSTEXPR inline bool ctti_type_index::before(const ctti_type_index& rhs) const noexcept {
    const char* const left = raw_name();
    const char* const right = rhs.raw_name();
    return /*left != right &&*/ mars_boost::typeindex::detail::constexpr_strcmp(left, right) < 0;
}
...
BOOST_CXX14_CONSTEXPR inline ctti_type_index ctti_type_index::type_id() noexcept {
    ...
    return ctti_type_index(mars_boost::detail::ctti<no_cvr_t>::n());
}
...
BOOST_CXX14_CONSTEXPR inline ctti_type_index ctti_type_index::type_id_with_cvr() noexcept {
    return ctti_type_index(mars_boost::detail::ctti<T>::n());
}
