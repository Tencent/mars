...
static void equal_test()
{
  ...
  mars_boost::function<int(void)> g;
...
static void ref_equal_test()
{
  {
    ReturnInt ri(17);
    mars_boost::function0<int> f = mars_boost::ref(ri);

    // References and values are equal
    BOOST_CHECK(f == mars_boost::ref(ri));
    BOOST_CHECK(f == ri);
    BOOST_CHECK(mars_boost::ref(ri) == f);
    BOOST_CHECK(!(f != mars_boost::ref(ri)));
    BOOST_CHECK(!(f != ri));
    BOOST_CHECK(!(mars_boost::ref(ri) != f));
#if !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
    ...
    ReturnInt ri2(17);
    BOOST_CHECK(f == ri2);
    BOOST_CHECK(f != mars_boost::ref(ri2));
    BOOST_CHECK(mars_boost::ref(ri2) != f);
    BOOST_CHECK(!(f != ri2));
    BOOST_CHECK(!(f == mars_boost::ref(ri2)));
    BOOST_CHECK(!(mars_boost::ref(ri2) == f));
#if !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
  ...
  {
    ReturnInt ri(17);
    mars_boost::function<int(void)> f = mars_boost::ref(ri);
