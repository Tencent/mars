...
{
  mars_boost::signals2::signal
  <
    int (),
    mars_boost::signals2::last_value<int>,
    int,
    std::greater< int >
  > sig;

  sig.connect( 1, mars_boost::bind( &return_argument, 1) );
  sig.connect( 2, mars_boost::bind( &return_argument, 2) );
...
BOOST_AUTO_TEST_CASE(test_main)
{
  ...
  sig.connect(emit_int(17), mars_boost::signals2::at_front);
