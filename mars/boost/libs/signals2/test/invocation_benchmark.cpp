...
typedef mars_boost::signals2::signal<void ()> signal_type;
...
int main(int argc, const char **argv)
{
  ...
  mars_boost::thread_group threads;
  signal_type sig;
  ...
  {
    threads.create_thread(mars_boost::bind(&thread_initial, &sig, signal_invocations_per_thread));
  }
  threads.join_all();
  return 0;
}
