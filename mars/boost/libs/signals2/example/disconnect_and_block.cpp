...
//[ disconnect_code_snippet
  mars_boost::signals2::connection c = sig.connect(HelloWorld());
...
//[ block_code_snippet
  ...
  {
    mars_boost::signals2::shared_connection_block block(c); // block the slot
...
//[ scoped_connection_code_snippet
  {
    mars_boost::signals2::scoped_connection c(sig.connect(ShortLived()));
