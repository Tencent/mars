...
public:
    ...
    {
        m_connection = m_document.connect(mars_boost::bind(&TextView::refresh, this));
    }
...
private:
    Document&               m_document;
    mars_boost::signals2::connection  m_connection;
};
//]
...
public:
    ...
    {
        m_connection = m_document.connect(mars_boost::bind(&HexView::refresh, this));
    }
