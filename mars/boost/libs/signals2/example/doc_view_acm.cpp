...
public:
  ...
  static mars_boost::shared_ptr<TextView> create(Document& doc)
  {
    mars_boost::shared_ptr<TextView> new_view(new TextView(doc));
    {
...
public:
  // static factory function that sets up automatic connection tracking
  static mars_boost::shared_ptr<HexView> create(Document& doc)
  {
    mars_boost::shared_ptr<HexView> new_view(new HexView(doc));
    {
      typedef Document::signal_t::slot_type slot_type;
  ...
  void refresh() const
  {
    mars_boost::io::ios_flags_saver ifs(std::cout);
...
{
  Document    doc;
  mars_boost::shared_ptr<TextView> v1 = TextView::create(doc);
  mars_boost::shared_ptr<HexView> v2 = HexView::create(doc);
