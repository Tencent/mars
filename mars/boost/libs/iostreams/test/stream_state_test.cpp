...
using mars_boost::iostreams::detail::bad_read;
using mars_boost::iostreams::detail::bad_seek;
using mars_boost::iostreams::detail::bad_write;
using mars_boost::iostreams::seekable_device_tag;
using mars_boost::iostreams::stream;
using mars_boost::iostreams::stream_offset;
