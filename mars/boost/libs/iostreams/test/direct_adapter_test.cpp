...
void direct_adapter_test()
{
    ...
    typedef mars_boost::iostreams::detail::direct_adapter<array_source> 
            indirect_array_source;
    typedef mars_boost::iostreams::detail::direct_adapter<array_sink> 
            indirect_array_sink;
    typedef mars_boost::iostreams::detail::direct_adapter<mars_boost::iostreams::array> 
            indirect_array;
