...
namespace mars_boost_ios = mars_boost::iostreams;
using std::ifstream;
...
void file_handle_test_impl(FileDescriptor*)
{
    ...
    {
        mars_boost_ios::detail::file_handle handle = open_file_handle(test1.name());
        {
            FileDescriptor device1(handle, mars_boost_ios::never_close_handle);
...

    {
        mars_boost_ios::detail::file_handle handle = open_file_handle(test1.name());
        {
            FileDescriptor device1(handle, mars_boost_ios::close_handle);
            BOOST_CHECK(device1.handle() == handle);
        }
    ...
    {
        mars_boost_ios::detail::file_handle handle1 = open_file_handle(test1.name());
        mars_boost_ios::detail::file_handle handle2 = open_file_handle(test2.name());
        {
            FileDescriptor device1(handle1, mars_boost_ios::never_close_handle);
            BOOST_CHECK(device1.handle() == handle1);
            device1.open(handle2, mars_boost_ios::never_close_handle);
...

    {
        ...
        mars_boost_ios::detail::file_handle handle2 = open_file_handle(test2.name());
        {
            FileDescriptor device1(handle1, mars_boost_ios::close_handle);
            BOOST_CHECK(device1.handle() == handle1);
            device1.open(handle2, mars_boost_ios::close_handle);
            BOOST_CHECK(device1.handle() == handle2);
...

    {
        mars_boost_ios::detail::file_handle handle = open_file_handle(test1.name());
        {
            ...
            BOOST_CHECK(!device1.is_open());
            device1.open(handle, mars_boost_ios::never_close_handle);
            BOOST_CHECK(device1.handle() == handle);
            BOOST_CHECK_HANDLE_OPEN(handle);
        }
        BOOST_CHECK_HANDLE_OPEN(handle);
...

    {
        mars_boost_ios::detail::file_handle handle = open_file_handle(test1.name());
        {
            FileDescriptor device1;
            BOOST_CHECK(!device1.is_open());
            device1.open(handle, mars_boost_ios::close_handle);
            BOOST_CHECK(device1.handle() == handle);
            BOOST_CHECK_HANDLE_OPEN(handle);
        }
        BOOST_CHECK_HANDLE_CLOSED(handle);
...
{
    file_handle_test_impl((mars_boost_ios::file_descriptor*) 0);
    file_handle_test_impl((mars_boost_ios::file_descriptor_source*) 0);
    file_handle_test_impl((mars_boost_ios::file_descriptor_sink*) 0);
}
