...
namespace ios_test = mars_boost::iostreams::test;
...
void file_handle_test_impl(FileDescriptor*)
{
    ...
    {
        mars_boost_ios::detail::file_handle handle = ios_test::open_file_handle(test1.name());
        {
    ...
    {
        mars_boost_ios::detail::file_handle handle1 = ios_test::open_file_handle(test1.name());
        mars_boost_ios::detail::file_handle handle2 = ios_test::open_file_handle(test1.name());
...
{
    mars_boost::unit_test::test_suite* test = BOOST_TEST_SUITE("deprecated file_descriptor test");
