...
{
    {
        std::unique_ptr<int[]> result = mars_boost::make_unique<int[]>(3);
    ...
    }
    {
        std::unique_ptr<int[][2]> result =
            mars_boost::make_unique<int[][2]>(2);
        BOOST_TEST(result.get() != 0);
    ...
    }
    {
        std::unique_ptr<const int[]> result =
            mars_boost::make_unique<const int[]>(3);
        BOOST_TEST(result.get() != 0);
        BOOST_TEST(result[0] == 0);
        BOOST_TEST(result[1] == 0);
        BOOST_TEST(result[2] == 0);
    }
    {
        std::unique_ptr<const int[][2]> result =
            mars_boost::make_unique<const int[][2]>(2);
        BOOST_TEST(result.get() != 0);
        BOOST_TEST(result[0][0] == 0);
        BOOST_TEST(result[0][1] == 0);
        BOOST_TEST(result[1][0] == 0);
    ...
    BOOST_TEST(type::instances == 0);
    {
        std::unique_ptr<type[][2]> result =
            mars_boost::make_unique<type[][2]>(2);
        BOOST_TEST(result.get() != 0);
    ...
    BOOST_TEST(type::instances == 0);
    {
        std::unique_ptr<const type[]> result =
            mars_boost::make_unique<const type[]>(3);
        BOOST_TEST(result.get() != 0);
        BOOST_TEST(type::instances == 3);
        result.reset();
        BOOST_TEST(type::instances == 0);
    ...
    BOOST_TEST(type::instances == 0);
    {
        std::unique_ptr<const type[][2]> result =
            mars_boost::make_unique<const type[][2]>(2);
        BOOST_TEST(result.get() != 0);
        BOOST_TEST(type::instances == 4);
        result.reset();
        BOOST_TEST(type::instances == 0);
