...
mars_boost::shared_ptr<Y> createY();

void test()
{
    mars_boost::shared_ptr<Y> py = createY();
    BOOST_TEST(py.get() != 0);
...
class impl: public X, public virtual Y, public virtual mars_boost::enable_shared_from_raw
{
public:
    ...
    {
        mars_boost::shared_ptr<impl> pi = mars_boost::shared_from_raw( this );
...
mars_boost::shared_ptr<Y> createY()
{
    mars_boost::shared_ptr<Y> pi(new impl2);
    return pi;
}

void test2()
{
    mars_boost::shared_ptr<Y> pi(static_cast<impl2*>(0));
}

//

struct V: public mars_boost::enable_shared_from_raw
{
};
...
void test3()
{
    ...
    try
    {
        mars_boost::shared_ptr<V> q = mars_boost::shared_from_raw( p.get() );
        BOOST_TEST( p == q );
        BOOST_TEST( !(p < q) && !(q < p) );
    }
    catch( mars_boost::bad_weak_ptr const & )
    ...
    try
    {
        ...
        mars_boost::shared_ptr<V> r = mars_boost::shared_from_raw( &v2 );
    ...
    {
        *p = V();
        mars_boost::shared_ptr<V> r = mars_boost::shared_from_raw( p.get() );
        BOOST_TEST( p == r );
        BOOST_TEST( !(p < r) && !(r < p) );
    }
    catch( mars_boost::bad_weak_ptr const & )
