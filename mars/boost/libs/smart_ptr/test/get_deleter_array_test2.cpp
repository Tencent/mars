...
int main()
{
    ...
    {
        mars_boost::shared_ptr<X[]> p(new X[1]);
    ...
    {
        mars_boost::shared_ptr<X[1]> p(new X[1]);
    ...
    {
        X x[1];
        mars_boost::shared_ptr<X[1]> p(x, deleter());
