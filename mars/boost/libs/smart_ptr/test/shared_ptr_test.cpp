...
void test()
{
    typedef mars_boost::shared_ptr<int>::element_type T;
    T t;
    f(t);
}
...
void default_constructor()
{
    ...
    {
        mars_boost::shared_ptr<incomplete> px;
...
void pointer_constructor()
{
    ...
    {
        mars_boost::shared_ptr<int const> pi(static_cast<int*>(0));
        BOOST_TEST(pi? false: true);
        BOOST_TEST(!pi);
        BOOST_TEST(pi.get() == 0);
    ...
    {
        mars_boost::shared_ptr<int volatile> pi(static_cast<int*>(0));
        BOOST_TEST(pi? false: true);
        BOOST_TEST(!pi);
        BOOST_TEST(pi.get() == 0);
        BOOST_TEST(pi.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void> pv(static_cast<int*>(0));
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
    ...
    {
        mars_boost::shared_ptr<void const> pv(static_cast<int*>(0));
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<X const> px(static_cast<X*>(0));
        BOOST_TEST(px? false: true);
        BOOST_TEST(!px);
        BOOST_TEST(px.get() == 0);
    ...
    {
        mars_boost::shared_ptr<X> px(static_cast<Y*>(0));
        BOOST_TEST(px? false: true);
        BOOST_TEST(!px);
        BOOST_TEST(px.get() == 0);
        BOOST_TEST(px.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<X const> px(static_cast<Y*>(0));
        BOOST_TEST(px? false: true);
        BOOST_TEST(!px);
        BOOST_TEST(px.get() == 0);
        BOOST_TEST(px.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void> pv(static_cast<X*>(0));
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void const> pv(static_cast<X*>(0));
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        int * p = new int(7);
        mars_boost::shared_ptr<int> pi(p);
    ...
    {
        int * p = new int(7);
        mars_boost::shared_ptr<int const> pi(p);
        BOOST_TEST(pi? true: false);
        BOOST_TEST(!!pi);
        BOOST_TEST(pi.get() == p);
        BOOST_TEST(pi.use_count() == 1);
    ...
    {
        int * p = new int(7);
        mars_boost::shared_ptr<void> pv(p);
    ...
    {
        int * p = new int(7);
        mars_boost::shared_ptr<void const> pv(p);
        BOOST_TEST(pv? true: false);
        BOOST_TEST(!!pv);
        BOOST_TEST(pv.get() == p);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        X * p = new X;
        mars_boost::shared_ptr<X const> px(p);
        BOOST_TEST(px? true: false);
        BOOST_TEST(!!px);
        BOOST_TEST(px.get() == p);
        BOOST_TEST(px.use_count() == 1);
...
{
    {
        mars_boost::shared_ptr<int> pi(static_cast<int*>(0), deleter);
        BOOST_TEST(pi? false: true);
        BOOST_TEST(!pi);
        BOOST_TEST(pi.get() == 0);
        BOOST_TEST(pi.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void> pv(static_cast<int*>(0), &deleter);
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void const> pv(static_cast<int*>(0), deleter);
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<incomplete> px(p0, deleter3());
        BOOST_TEST(px? false: true);
        BOOST_TEST(!px);
        BOOST_TEST(px.get() == 0);
        BOOST_TEST(px.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void> pv(p0, deleter3());
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void const> pv(p0, deleter3());
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
        BOOST_TEST(pv.get() == 0);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<int> pi(&m, deleter2);
        BOOST_TEST(pi? true: false);
        BOOST_TEST(!!pi);
        BOOST_TEST(pi.get() == &m);
        BOOST_TEST(pi.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<int const> pi(&m, &deleter2);
        BOOST_TEST(pi? true: false);
        BOOST_TEST(!!pi);
        BOOST_TEST(pi.get() == &m);
        BOOST_TEST(pi.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void> pv(&m, deleter2);
        BOOST_TEST(pv? true: false);
        BOOST_TEST(!!pv);
        BOOST_TEST(pv.get() == &m);
        BOOST_TEST(pv.use_count() == 1);
    ...
    {
        mars_boost::shared_ptr<void const> pv(&m, &deleter2);
        BOOST_TEST(pv? true: false);
        BOOST_TEST(!!pv);
        BOOST_TEST(pv.get() == &m);
        BOOST_TEST(pv.use_count() == 1);
...
{
    {
        ...
        mars_boost::shared_ptr<int> pi2(pi);
        BOOST_TEST(pi2 == pi);
        ...
        mars_boost::shared_ptr<void> pi3(pi);
        BOOST_TEST(pi3 == pi);
        ...
        mars_boost::shared_ptr<void> pi4(pi3);
        BOOST_TEST(pi4 == pi3);
...

    {
        ...
        mars_boost::shared_ptr<void> pv2(pv);
        BOOST_TEST(pv2 == pv);
...

    {
        ...
        mars_boost::shared_ptr<incomplete> px2(px);
        BOOST_TEST(px2 == px);
        ...
        mars_boost::shared_ptr<void> px3(px);
        BOOST_TEST(px3 == px);
    ...
    {
        mars_boost::shared_ptr<int> pi(static_cast<int*>(0));
        ...
        mars_boost::shared_ptr<void> pi4(pi2);
        BOOST_TEST(pi4 == pi2);
        BOOST_TEST(pi4? false: true);
        BOOST_TEST(!pi4);
        BOOST_TEST(pi4.get() == 0);
    ...
    {
        mars_boost::shared_ptr<X> px(static_cast<X*>(0));

        mars_boost::shared_ptr<X> px2(px);
        BOOST_TEST(px2 == px);
        BOOST_TEST(px2? false: true);
        BOOST_TEST(!px2);
        BOOST_TEST(px2.get() == 0);
        ...
        mars_boost::shared_ptr<void> px4(px2);
        BOOST_TEST(px4 == px2);
    ...
    {
        Y * p = new Y;
        mars_boost::shared_ptr<Y> py(p);
        BOOST_TEST(py.get() == p);

        mars_boost::shared_ptr<X> px(py);
        BOOST_TEST(px == py);
        BOOST_TEST(px? true: false);
        BOOST_TEST(!!px);
        BOOST_TEST(px.get() == p);
        ...
        mars_boost::shared_ptr<void const> pv(px);
        BOOST_TEST(pv == px);
        BOOST_TEST(pv? true: false);
        BOOST_TEST(!!pv);
        ...
        mars_boost::shared_ptr<void const> pv2(py);
        BOOST_TEST(pv2 == py);
        BOOST_TEST(pv2? true: false);
        BOOST_TEST(!!pv2);
...
{
    {
        mars_boost::weak_ptr<Y> wp;
        BOOST_TEST(wp.use_count() == 0);

        try
        {
            mars_boost::shared_ptr<Y> p2(wp);
    ...
    {
        mars_boost::shared_ptr<Y> p;
        mars_boost::weak_ptr<Y> wp(p);
    ...
    {
        mars_boost::shared_ptr<Y> p(new Y);
        mars_boost::weak_ptr<Y> wp(p);
...
{
    {
        mars_boost::shared_ptr<incomplete> p1;
        ...
        mars_boost::shared_ptr<incomplete> p2;
        ...
        mars_boost::shared_ptr<incomplete> p3(p1);
...

    {
        ...
        mars_boost::shared_ptr<void> p4(new int);
...

    {
        ...
        mars_boost::shared_ptr<X> p4(new X);
...
{
    {
        ...
        mars_boost::shared_ptr<int> p4(new int);
        BOOST_TEST(p4.use_count() == 1);

        mars_boost::shared_ptr<void> p5(p4);
        BOOST_TEST(p4.use_count() == 2);
...

    {
        ...
        mars_boost::shared_ptr<Y> p4(new Y);

        BOOST_TEST(X::instances == 1);
        BOOST_TEST(Y::instances == 1);
        BOOST_TEST(p4.use_count() == 1);

        mars_boost::shared_ptr<X> p5(p4);
        BOOST_TEST(p4.use_count() == 2);
...
void plain_reset()
{
    ...
    {
        mars_boost::shared_ptr<incomplete> px(p0, deleter);
        px.reset();
        BOOST_TEST(px? false: true);
        BOOST_TEST(!px);
        BOOST_TEST(px.get() == 0);
    ...
    {
        BOOST_TEST(X::instances == 0);
        mars_boost::shared_ptr<void> pv(new X);
        BOOST_TEST(X::instances == 1);
        pv.reset();
        BOOST_TEST(pv? false: true);
        BOOST_TEST(!pv);
...
void test()
{
    ...
    {
        mars_boost::shared_ptr<X> px(static_cast<X*>(0), mars_boost::checked_deleter<X>());
        BOOST_TEST(px.get() == 0);
        BOOST_TEST(px? false: true);
        BOOST_TEST(!px);
    ...
    {
        X * p = new X;
        mars_boost::shared_ptr<X> px(p, mars_boost::checked_deleter<X>());
        BOOST_TEST(px.get() == p);
        BOOST_TEST(px? true: false);
        BOOST_TEST(!!px);
        BOOST_TEST(&*px == px.get());
...
void test()
{
    ...
    {
        mars_boost::shared_ptr<X> px(new X, mars_boost::checked_deleter<X>());
        BOOST_TEST(px.use_count() == 1);
        BOOST_TEST(px.unique());
...
void test()
{
...

    {
        X * p = new X;
        mars_boost::shared_ptr<X> px;
        mars_boost::shared_ptr<X> px2(p);
        mars_boost::shared_ptr<X> px3(px2);
...

    {
        X * p1 = new X;
        X * p2 = new X;
        mars_boost::shared_ptr<X> px(p1);
        mars_boost::shared_ptr<X> px2(p2);
        mars_boost::shared_ptr<X> px3(px2);
...
void test()
{
    ...
    {
        mars_boost::shared_ptr<X> px(new X);
        mars_boost::shared_ptr<Y> py(new Y);
        mars_boost::shared_ptr<Z> pz(new Z);
        ...
        mars_boost::shared_ptr<void> pvx(px);

        BOOST_TEST(pvx == pvx);
        BOOST_TEST(!(pvx != pvx));
        BOOST_TEST(!(pvx < pvx));

        mars_boost::shared_ptr<void> pvy(py);
        mars_boost::shared_ptr<void> pvz(pz);
    ...
    {
        mars_boost::shared_ptr<Z> pz(new Z);
        mars_boost::shared_ptr<X> px(pz);

        BOOST_TEST(px == px);
        BOOST_TEST(!(px != px));
        BOOST_TEST(!(px < px));

        mars_boost::shared_ptr<Y> py(pz);
...
{
    {
        ...
        mars_boost::shared_ptr<int> pi = mars_boost::static_pointer_cast<int>(pv);
        BOOST_TEST(pi.get() == 0);

        mars_boost::shared_ptr<X> px = mars_boost::static_pointer_cast<X>(pv);
        BOOST_TEST(px.get() == 0);
    }

    {
        mars_boost::shared_ptr<int> pi(new int);
        mars_boost::shared_ptr<void> pv(pi);

        mars_boost::shared_ptr<int> pi2 = mars_boost::static_pointer_cast<int>(pv);
    ...
    {
        mars_boost::shared_ptr<X> px(new X);
        mars_boost::shared_ptr<void> pv(px);

        mars_boost::shared_ptr<X> px2 = mars_boost::static_pointer_cast<X>(pv);
        BOOST_TEST(px.get() == px2.get());
        BOOST_TEST(!(px < px2 || px2 < px));
...

    {
        ...
        mars_boost::shared_ptr<Y> py = mars_boost::static_pointer_cast<Y>(px);
        BOOST_TEST(px.get() == py.get());
        BOOST_TEST(px.use_count() == 2);
        BOOST_TEST(py.use_count() == 2);

        mars_boost::shared_ptr<X> px2(py);
        BOOST_TEST(!(px < px2 || px2 < px));
    }
}
...
{
    {
        mars_boost::shared_ptr<void const volatile> px;

        mars_boost::shared_ptr<void> px2 = mars_boost::const_pointer_cast<void>(px);
        BOOST_TEST(px2.get() == 0);
    }

    {
        mars_boost::shared_ptr<int const volatile> px;
    ...
    {
        mars_boost::shared_ptr<X const volatile> px;

        mars_boost::shared_ptr<X> px2 = mars_boost::const_pointer_cast<X>(px);
        BOOST_TEST(px2.get() == 0);
    }

    {
        mars_boost::shared_ptr<void const volatile> px(new int);
...
{
    {
        mars_boost::shared_ptr<V> pv;
        mars_boost::shared_ptr<W> pw = mars_boost::dynamic_pointer_cast<W>(pv);
        BOOST_TEST(pw.get() == 0);
    }

    {
        mars_boost::shared_ptr<V> pv(static_cast<V*>(0));

        mars_boost::shared_ptr<W> pw = mars_boost::dynamic_pointer_cast<W>(pv);
        BOOST_TEST(pw.get() == 0);

        mars_boost::shared_ptr<V> pv2(pw);
        BOOST_TEST(pv < pv2 || pv2 < pv);
    }

    {
        mars_boost::shared_ptr<V> pv(static_cast<W*>(0));
    ...
    {
        mars_boost::shared_ptr<V> pv(new V);
    ...
    {
        mars_boost::shared_ptr<V> pv(new W);
...
void test()
{
    ...
    std::map< mars_boost::shared_ptr<void>, long > m;
    ...
    {
        for(std::map< mars_boost::shared_ptr<void>, long >::iterator i = m.begin(); i != m.end(); ++i)
        {
...
{
    X(): next() {}
    mars_boost::shared_ptr<X> next;
};

void test()
{
    mars_boost::shared_ptr<X> p(new X);
    p->next = mars_boost::shared_ptr<X>(new X);
...
private:
    ...
    mars_boost::shared_ptr<foo> m_self;
}; 
...
public:
    ...
    void setWeak(mars_boost::shared_ptr<foo> s)
    {
        w = s;
    }
...
void test()
{
    mars_boost::shared_ptr<foo> s(new foo, deleter());
    s->setWeak(s);
    s.reset();
}
...
mars_boost::shared_ptr<file> fopen(char const * name, char const * mode);
void fread(mars_boost::shared_ptr<file> f, void * data, long size);
...
void test()
{
    ...
    {
        mars_boost::shared_ptr<file> pf = fopen("name", "mode");
...
private:
    ...
    class impl;
    mars_boost::shared_ptr<impl> pimpl_;
...
mars_boost::shared_ptr<X> createX();
...
void test()
{
    ...
    {
        mars_boost::shared_ptr<X> px = createX();
...
public:
    ...
    {
        mars_boost::shared_ptr<X> px(new X, X::deleter());
        return px;
    }
};
...
void test()
{
    ...
    {
        mars_boost::shared_ptr<X> px = X::create();
        BOOST_TEST(X_instances == 1);
    }
...
void test()
{
    ...
    {
        mars_boost::shared_ptr<X> px(new X[4], mars_boost::checked_array_deleter<X>());
...
void test()
{
    mars_boost::shared_ptr<X> px(&x, null_deleter());
}
...
mars_boost::shared_ptr<X> make_shared_from_intrusive(X * p)
{
    if(p != 0) intrusive_ptr_add_ref(p);
    mars_boost::shared_ptr<X> px(p, intrusive_deleter<X>());
    return px;
}
...
void test()
{
...

    {
        ...
        mars_boost::shared_ptr<X> px = make_shared_from_intrusive(p);
        BOOST_TEST(px.get() == p);
...
template<class T> class another_ptr: private mars_boost::shared_ptr<T>
{
private:

    typedef mars_boost::shared_ptr<T> base_type;
...
mars_boost::shared_ptr<event_handler> current_handler;

void install_event_handler(mars_boost::shared_ptr<event_handler> p)
{
    p->begin();
    current_handler = p;
}
...
void test()
{
    ...
    mars_boost::shared_ptr<event_handler> q(p.get(), smart_pointer_deleter< another_ptr<event_handler> >(p));
...
public:
    ...
    virtual mars_boost::shared_ptr<X> getX() = 0;
...
private:
    ...
    mars_boost::weak_ptr<impl> weak_this;
...
public:
    ...
    static mars_boost::shared_ptr<impl> create()
    {
        mars_boost::shared_ptr<impl> pi(new impl);
        pi->weak_this = pi;
        return pi;
    }
    ...
    virtual mars_boost::shared_ptr<X> getX()
    {
        mars_boost::shared_ptr<X> px = weak_this.lock();
        return px;
    }
};
...
void test()
{
    mars_boost::shared_ptr<Y> py = impl::create();
    BOOST_TEST(py.get() != 0);
    BOOST_TEST(py.use_count() == 1);

    mars_boost::shared_ptr<X> px = py->getX();
    BOOST_TEST(px.get() != 0);
    BOOST_TEST(py.use_count() == 2);

#if !defined( BOOST_NO_RTTI )
    mars_boost::shared_ptr<Y> py2 = mars_boost::dynamic_pointer_cast<Y>(px);
...
mars_boost::shared_ptr<file> fopen(char const *, char const *)
{
    mars_boost::shared_ptr<file> pf(new file);
    return pf;
}

void fread(mars_boost::shared_ptr<file> pf, void *, long)
{
...
mars_boost::shared_ptr<X> createX()
{
    mars_boost::shared_ptr<X> px(new X_impl);
    return px;
}
