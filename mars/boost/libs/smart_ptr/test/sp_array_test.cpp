...
int main()
{
...

    {
        ...
        mars_boost::shared_ptr<X[]> px2( new X[ 3 ] );
        BOOST_TEST( px2 );
        ...
        mars_boost::shared_ptr<X const[]> px3( px2 );
        BOOST_TEST( px3 == px2 );
        ...
        mars_boost::shared_ptr<X volatile[]> px4( px2 );
        BOOST_TEST( px4 == px2 );
        ...
        mars_boost::shared_ptr<void> px5( px2 );
        BOOST_TEST( px5 == px2 );
...

    {
        ...
        mars_boost::shared_ptr<X[]> px2( std::move( px ) );
        BOOST_TEST( X::allocations == 1 );
        BOOST_TEST( X::instances == 4 );
        BOOST_TEST( px.get() == 0 );
    ...
    {
        mars_boost::shared_ptr<X[]> px( new X[ 5 ], array_deleter< X >() );
        BOOST_TEST( X::allocations == 1 );
    ...
    {
        mars_boost::shared_ptr<X[]> px( new X[ 6 ], array_deleter< X >(), std::allocator< X >() );
        BOOST_TEST( X::allocations == 1 );
