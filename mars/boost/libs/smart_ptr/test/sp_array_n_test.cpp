...
int main()
{
    ...
    {
        mars_boost::shared_ptr<X[3]> px;
        BOOST_TEST( !px );

        BOOST_TEST( X::allocations == 0 );
        BOOST_TEST( X::instances == 0 );

        mars_boost::shared_ptr<X[3]> px2( new X[ 3 ] );
        BOOST_TEST( px2 );
        ...
        mars_boost::shared_ptr<X const[3]> px3( px2 );
        BOOST_TEST( px3 == px2 );
        ...
        mars_boost::shared_ptr<X volatile[3]> px4( px2 );
        BOOST_TEST( px4 == px2 );
    ...
    {
        mars_boost::shared_ptr<X[5]> px( new X[ 5 ], array_deleter< X >() );
        BOOST_TEST( X::allocations == 1 );
    ...
    {
        mars_boost::shared_ptr<X[6]> px( new X[ 6 ], array_deleter< X >(), std::allocator< X >() );
        BOOST_TEST( X::allocations == 1 );
