...
class my_class :
    public mars_boost::intrusive_ref_counter< my_class >
{
public:
...
class my_class :
    public mars_boost::intrusive_ref_counter< my_class, mars_boost::thread_unsafe_counter >
{
public:
    static unsigned int destructor_count;
...
struct root :
    public mars_boost::intrusive_ref_counter< root >
{
    virtual ~root() {}
};
...
int main()
{
    ...
    {
        mars_boost::intrusive_ptr< N1::my_class > p = new N1::my_class();
        p = NULL;
        BOOST_TEST(N1::my_class::destructor_count == 1);
    }
    {
        mars_boost::intrusive_ptr< N2::my_class > p = new N2::my_class();
        p = NULL;
    ...
    {
        mars_boost::intrusive_ptr< N6::Z > p1 = new N6::Z();
        BOOST_TEST(p1->use_count() == 1);
        BOOST_TEST(N6::Z::destructor_count == 0);
        mars_boost::intrusive_ptr< N3::root > p2 = p1;
