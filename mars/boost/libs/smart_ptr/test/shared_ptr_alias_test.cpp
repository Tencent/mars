...
{
    {
        ...
        mars_boost::shared_ptr< int > p2( p, &m );
...

    {
        ...
        mars_boost::shared_ptr< int const > p2( p, &m );
    ...
    {
        mars_boost::shared_ptr< int > p( new int );
        mars_boost::shared_ptr< void const > p2( p, 0 );
...

    {
        ...
        mars_boost::shared_ptr< incomplete > p2( p, 0 );
...

    {
        ...
        mars_boost::shared_ptr< int const > p2( p, &p->v_ );
        ...
        mars_boost::shared_ptr< X const > p3( new X( 8 ) );
        p2.reset( p3, &p3->v_ );
