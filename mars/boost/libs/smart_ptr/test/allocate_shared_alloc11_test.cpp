...
{
    {
        mars_boost::shared_ptr< int > pi = mars_boost::allocate_shared< int >( cxx11_allocator<int>() );
    ...
    {
        mars_boost::shared_ptr< int > pi = mars_boost::allocate_shared< int >( cxx11_allocator<int>(), 5 );
