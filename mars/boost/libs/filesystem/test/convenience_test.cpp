...
using fs::path;
namespace sys = mars_boost::system;
...
int cpp_main(int, char*[])
{
    ...
    BOOST_TEST(throws_fs_error(
        mars_boost::bind(fs::create_directories, is_a_file)));
    BOOST_TEST(throws_fs_error(
        mars_boost::bind(fs::create_directories, is_a_file / "aa")));
    ...
    BOOST_TEST(throws_fs_error(
        mars_boost::bind(create_recursive_iterator, "/no-such-path")));
