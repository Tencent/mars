...
BOOST_FILESYSTEM_DECL mars_boost::system::error_category const& codecvt_error_category() BOOST_NOEXCEPT
{
    static
...
{
    codecvt_error_category_initializer() { mars_boost::filesystem::codecvt_error_category(); }
};
