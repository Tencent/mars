...
namespace rt = mars_boost::runtime;
...
register_parameters( rt::parameters_store& store )
{
    rt::option auto_start_dbg( btrt_auto_start_dbg, (
        ...
        rt::help = "Specifies whether Boost.Test should attempt "
                   ...
                   "Boost.Test debug API, specifically the function mars_boost::debug::set_debugger."
    ));
...
init( int& argc, char** argv )
{
    ...
    BOOST_TEST_I_TRY {
        ...
        if( runtime_config::get<bool>( btrt_version ) ) {
            ...
            BOOST_TEST_I_THROW( framework::nothing_to_test( mars_boost::exit_success ) );
        }
