...
typedef ::mars_boost::io::ios_base_all_saver io_saver_type;
...
struct unit_test_log_data_helper_impl {
  typedef mars_boost::shared_ptr<unit_test_log_formatter> formatter_ptr;
  typedef mars_boost::shared_ptr<io_saver_type>           saver_ptr;
