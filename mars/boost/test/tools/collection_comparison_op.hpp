...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace test_tools { namespace assertion {  \
template<>                                                      \
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::EQ<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::EQ<L, R> >*, mpl::false_ )
{
    return lhs == rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::NE<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::NE<L, R> >*, mpl::false_ )
{
    return lhs != rhs;
}
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<OP>*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::LT<L, R> >*, mpl::false_ )
{
    return lhs < rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::LE<L, R> >*, mpl::false_ )
{
    return lhs <= rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::GT<L, R> >*, mpl::false_ )
{
    return lhs > rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, mars_boost::type<op::GE<L, R> >*, mpl::false_ )
{
    return lhs >= rhs;
}
...
template<typename Lhs,typename Rhs>                                 \
struct name<Lhs,Rhs,typename mars_boost::enable_if_c<                    \
