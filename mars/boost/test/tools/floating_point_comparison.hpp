...
template<typename FPT>
struct fpt_limits : mars_boost::conditional<std::numeric_limits<FPT>::is_specialized,
 ...
 * by the @ref mars_boost::math::fpc::strength given at construction.
 *
 ...
 *
 * Serves the same purpose as mars_boost::math::fpc::close_at_tolerance, but used when one
