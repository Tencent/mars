...
// ************************************************************************** //
    ...
    namespace impl {
        ...
        std::ostream& boost_test_print_type(std::ostream& ostr, T const& t) {
            BOOST_STATIC_ASSERT_MSG( (mars_boost::has_left_shift<std::ostream,T>::value),
...
struct print_log_value {
    void    operator()( std::ostream& ostr, T const& t )
    {
        ...
        //ostr << t;
        using mars_boost::test_tools::tt_detail::boost_test_print_type;
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost{ namespace test_tools{ namespace tt_detail{ \
template<>                                                  \
