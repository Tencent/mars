...
public:
    ...
    /// @returns
    ///   - @c mars_boost::exit_success on success,
    ///   - @c mars_boost::exit_exception_failure in case test unit
    ///     was aborted for any reason (including uncaught exception)
    ///   - and @c mars_boost::exit_test_failure otherwise
...
/// of the test tree.
///
/// @see mars_boost::unit_test::test_observer
