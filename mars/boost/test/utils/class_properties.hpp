...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return mars_boost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) mars_boost::unit_test::readwrite_property<property_type >
...
: public mars_boost::unit_test::readonly_property<property_type > {                      \
    typedef mars_boost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return mars_boost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return mars_boost::addressof( base_prop::value ); }
