...
#define BOOST_RTTI_SWITCH( type_id_ ) if( ::mars_boost::rtti::id_t switch_by_id = type_id_ )
#define BOOST_RTTI_CASE( type )       if( switch_by_id == ::mars_boost::rtti::type_id<type>() )
