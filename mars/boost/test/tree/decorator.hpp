...
class base;
typedef mars_boost::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( mars_boost::function<void()> const& setup, mars_boost::function<void()> const& teardown = mars_boost::function<void()>() )
{
...
public:
    typedef mars_boost::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
