...
#  define BOOST_LIB_NAME mars_boost_unit_test_framework
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace unit_test {
...
{
    return ::mars_boost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
