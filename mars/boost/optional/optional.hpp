...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace optional_detail {
...
template <typename T>
struct optional_value_type< ::mars_boost::optional<T> >
{
  typedef T type;
};

}} // namespace mars_boost::optional_detail
...
class optional_base : public optional_tag
{
  ...
  protected :
    ...
    typedef typename mars_boost::remove_const<T>::type unqualified_value_type;
  ...
  protected:
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value( mars_boost::move(rhs.get_impl()) );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( mars_boost::move(val) );
  ...
  protected :
    ...
    void construct ( rval_reference_type val )
     {
       ::new (m_storage.address()) unqualified_value_type( mars_boost::move(val) ) ;
       m_initialized = true ;
     }
#endif
    ...
    {
      ::new (m_storage.address()) unqualified_value_type( mars_boost::forward<Args>(args)... ) ;
      m_initialized = true ;
    }
    ...
    {
      destroy();
      construct(in_place_init, mars_boost::forward<Args>(args)...);
    }
    ...
    void construct ( in_place_init_t, Arg&& arg )
     {
       ::new (m_storage.address()) unqualified_value_type( mars_boost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       construct(in_place_init, mars_boost::forward<Arg>(arg)) ;
     }
    ...
    {
      new (m_storage.address()) unqualified_value_type(mars_boost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value( mars_boost::forward<Expr>(expr) );
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
    ...
    void construct ( Expr&& expr, optional_tag const* )
     {
       if ( expr.is_initialized() )
       {
         ...
         new (m_storage.address()) unqualified_value_type(mars_boost::move(expr.get())) ;
         m_initialized = true ;
       }
     }
#else
...
struct is_optional_or_tag
  : mars_boost::conditional< mars_boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME mars_boost::decay<U>::type>::value
                     || mars_boost::is_same<BOOST_DEDUCED_TYPENAME mars_boost::decay<U>::type, none_t>::value
                     || mars_boost::is_same<BOOST_DEDUCED_TYPENAME mars_boost::decay<U>::type, in_place_init_t>::value
                     || mars_boost::is_same<BOOST_DEDUCED_TYPENAME mars_boost::decay<U>::type, in_place_init_if_t>::value,
    mars_boost::true_type, mars_boost::false_type>::type
{};

template <typename T, typename U>
struct has_dedicated_constructor
  : mars_boost::disjunction<is_optional_or_tag<U>, mars_boost::is_same<T, BOOST_DEDUCED_TYPENAME mars_boost::decay<U>::type> >
{};

template <typename U>
struct is_in_place_factory
  : mars_boost::disjunction< mars_boost::is_base_of<mars_boost::in_place_factory_base, BOOST_DEDUCED_TYPENAME mars_boost::decay<U>::type>,
                        mars_boost::is_base_of<mars_boost::typed_in_place_factory_base, BOOST_DEDUCED_TYPENAME mars_boost::decay<U>::type> >
{};
...
struct is_factory_or_constructible_to_T
  : mars_boost::disjunction< is_in_place_factory<U>, mars_boost::is_constructible<T, U&&> >
{};

template <typename T, typename U>
struct is_optional_constructible : mars_boost::is_constructible<T, U>
{};

#else

template <typename, typename>
struct is_factory_or_constructible_to_T : mars_boost::true_type
{};

template <typename T, typename U>
struct is_optional_constructible : mars_boost::true_type
{};
...
struct is_opt_assignable
  : mars_boost::conjunction<mars_boost::is_convertible<U&&, T>, mars_boost::is_assignable<T&, U&&> >
{};
...
template <typename T, typename U>
struct is_opt_assignable : mars_boost::is_convertible<U, T>
{};
...
struct is_factory_or_opt_assignable_to_T
  : mars_boost::disjunction< is_in_place_factory<U>, is_opt_assignable<T, U> >
{};
...
struct optional_uses_direct_storage_for
  : mars_boost::conditional<(mars_boost::is_scalar<T>::value && !mars_boost::is_const<T>::value && !mars_boost::is_volatile<T>::value)
                      , mars_boost::true_type, mars_boost::false_type>::type
{};
...
#  define BOOST_OPTIONAL_BASE_TYPE(T) mars_boost::conditional< optional_config::optional_uses_direct_storage_for<T>::value, \
  ...
  : public BOOST_OPTIONAL_BASE_TYPE(T)
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base(optional_detail::init_value_tag(), mars_boost::forward<T>(val))
      {}
#endif
    ...
    /// Creates an optional<T> initialized with 'val' IFF cond is true, otherwise creates an uninitialized optional.
    // Can throw if T::T(T &&) does
    optional ( bool cond, rval_reference_type val ) : base( cond, mars_boost::forward<T>(val) )
      {}
#endif
    ...
    explicit optional ( optional<U> const& rhs
                        ...
                        ,BOOST_DEDUCED_TYPENAME mars_boost::enable_if< optional_detail::is_optional_constructible<T, U const&>, bool>::type = true
#endif
                      )
      :
      base()
...
#ifndef BOOST_OPTIONAL_DETAIL_NO_SFINAE_FRIENDLY_CONSTRUCTORS
                        ,BOOST_DEDUCED_TYPENAME mars_boost::enable_if< optional_detail::is_optional_constructible<T, U>, bool>::type = true
#endif
                      )
      :
      base()
  ...
  explicit optional ( Expr&& expr,
                      BOOST_DEDUCED_TYPENAME mars_boost::enable_if< optional_detail::is_optional_val_init_candidate<T, Expr>, bool>::type = true
  )
    ...
    template<class Expr>
    BOOST_DEDUCED_TYPENAME mars_boost::enable_if<optional_detail::is_optional_val_assign_candidate<T, Expr>, optional&>::type
    operator= ( Expr&& expr )
      {
    ...
    BOOST_DEDUCED_TYPENAME mars_boost::enable_if<mars_boost::is_same<T, BOOST_DEDUCED_TYPENAME mars_boost::decay<T_>::type>, optional&>::type
    operator= ( T_&& val )
      {
        this->assign( mars_boost::forward<T_>(val) ) ;
        return *this ;
      }
    ...
    : base( in_place_init, mars_boost::forward<Args>(args)... )
    {}

    template<class... Args>
    explicit optional ( in_place_init_if_t, bool cond, Args&&... args )
    : base( in_place_init_if, cond, mars_boost::forward<Args>(args)... )
    {}
    ...
    void swap( optional & arg )
      BOOST_NOEXCEPT_IF(::mars_boost::is_nothrow_move_constructible<T>::value && ::mars_boost::is_nothrow_move_assignable<T>::value)
      {
        ...
        mars_boost::core::invoke_swap(*this, arg);
      }
    ...
    reference_type_of_temporary_wrapper operator *() && { return mars_boost::move(this->get()) ; }
#else
    reference_const_type operator *() const { return this->get() ; }
    reference_type       operator *()       { return this->get() ; }
    ...
    reference_type_of_temporary_wrapper value() &&
      {
        if (this->is_initialized())
          return mars_boost::move(this->get()) ;
        else
          throw_exception(bad_optional_access());
      }
    ...
    template <typename F>
    optional<typename mars_boost::result_of<F(reference_type)>::type> map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename mars_boost::result_of<F(reference_const_type)>::type> map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename mars_boost::result_of<F(reference_type_of_temporary_wrapper)>::type> map(F f) &&
      {
        if (this->has_value())
          return f(mars_boost::move(this->get()));
        else
          return none;
      }

    template <typename F>
    optional<typename optional_detail::optional_value_type<typename mars_boost::result_of<F(reference_type)>::type>::type> flat_map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename mars_boost::result_of<F(reference_const_type)>::type>::type> flat_map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename mars_boost::result_of<F(reference_type_of_temporary_wrapper)>::type>::type> flat_map(F f) &&
      {
        if (this->has_value())
          return f(mars_boost::move(get()));
        else
          return none;
      }
...
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME mars_boost::decay<T>::type> make_optional ( T && v  )
{
  return optional<BOOST_DEDUCED_TYPENAME mars_boost::decay<T>::type>(mars_boost::forward<T>(v));
}

// Returns optional<T>(cond,v)
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME mars_boost::decay<T>::type> make_optional ( bool cond, T && v )
{
  return optional<BOOST_DEDUCED_TYPENAME mars_boost::decay<T>::type>(cond,mars_boost::forward<T>(v));
}
