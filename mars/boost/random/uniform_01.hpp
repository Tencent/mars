 ...
 * (to-be-invented) @c mars_boost::bigfloat class with random bits efficiently.
...
{
  typedef mars_boost::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
public:
