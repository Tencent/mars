...
template< >
struct path_source_traits< mars_boost::container::basic_string< char, std::char_traits< char >, void > >
{
...
template< >
struct path_source_traits< mars_boost::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > >
{
    typedef boost_container_string_tag tag_type;
    typedef wchar_t char_type;
    static BOOST_CONSTEXPR_OR_CONST bool is_native = false;
...
template< >
struct path_source_traits< mars_boost::basic_string_view< char, std::char_traits< char > > >
{
...
template< >
struct path_source_traits< mars_boost::basic_string_view< wchar_t, std::char_traits< wchar_t > > >
{
    typedef boost_string_view_tag tag_type;
    typedef wchar_t char_type;
    static BOOST_CONSTEXPR_OR_CONST bool is_native = false;
...
struct is_native_path_source :
    public mars_boost::integral_constant< bool, path_source_traits< T >::is_native >
{
};
...
struct is_path_source_iterator :
    public mars_boost::conjunction<
        mars_boost::iterators::is_iterator< Iterator >,
...
BOOST_FORCEINLINE typename Callback::result_type dispatch(Source const& source, Callback cb, const codecvt_type* cvt)
{
    return path_traits::dispatch(source, cb, cvt,
        typename path_traits::path_source_traits< typename mars_boost::remove_cv< Source >::type >::tag_type());
}
...
yes_type check_convertible(mars_boost::container::basic_string< char, std::char_traits< char >, void > const&);
yes_type check_convertible(mars_boost::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > const&);
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
yes_type check_convertible(std::string_view const&);
yes_type check_convertible(std::wstring_view const&);
#endif
yes_type check_convertible(mars_boost::basic_string_view< char, std::char_traits< char > > const&);
yes_type check_convertible(mars_boost::basic_string_view< wchar_t, std::char_traits< wchar_t > > const&);
...
struct is_convertible_to_path_source :
    public mars_boost::integral_constant<
        bool,
        sizeof(is_convertible_to_path_source_impl::check_convertible(mars_boost::declval< T const& >())) == sizeof(yes_type)
    >
{
};
...
struct is_convertible_to_std_string_view :
    public mars_boost::integral_constant<
        bool,
        sizeof(is_convertible_to_std_string_view_impl::check_convertible(mars_boost::declval< T const& >())) == sizeof(yes_type)
    >
{
};
...
struct is_convertible_to_path_source_non_std_string_view :
    public mars_boost::integral_constant<
        bool,
        sizeof(is_convertible_to_path_source_non_std_string_view_impl::check_convertible(mars_boost::declval< T const& >())) == sizeof(yes_type)
    >
{
};
...
(
    mars_boost::container::basic_string< char, std::char_traits< char >, void > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< mars_boost::container::basic_string< char, std::char_traits< char >, void >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE typename Callback::result_type dispatch_convertible_impl
(
    mars_boost::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< mars_boost::container::basic_string< wchar_t, std::char_traits< wchar_t >, void >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE typename Callback::result_type dispatch_convertible_impl
(
    mars_boost::basic_string_view< char, std::char_traits< char > > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< mars_boost::basic_string_view< char, std::char_traits< char > >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE typename Callback::result_type dispatch_convertible_impl
(
    mars_boost::basic_string_view< wchar_t, std::char_traits< wchar_t > > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< mars_boost::basic_string_view< wchar_t, std::char_traits< wchar_t > >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
{
    typedef typename mars_boost::remove_cv< Source >::type source_t;
...
template< typename Source, typename Callback >
BOOST_FORCEINLINE typename mars_boost::disable_if_c<
    is_convertible_to_std_string_view< typename mars_boost::remove_cv< Source >::type >::value,
...
template< typename Source, typename Callback >
BOOST_FORCEINLINE typename mars_boost::enable_if_c<
    is_convertible_to_std_string_view< typename mars_boost::remove_cv< Source >::type >::value,
    typename Callback::result_type
>::type dispatch_convertible(Source const& source, Callback cb, const codecvt_type* cvt = NULL)
{
