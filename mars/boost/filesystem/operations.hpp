...
BOOST_FILESYSTEM_DECL
mars_boost::uintmax_t file_size(path const& p, system::error_code* ec = NULL);
BOOST_FILESYSTEM_DECL
mars_boost::uintmax_t hard_link_count(path const& p, system::error_code* ec = NULL);
BOOST_FILESYSTEM_DECL
...
BOOST_FILESYSTEM_DECL
mars_boost::uintmax_t remove_all(path const& p, system::error_code* ec = NULL);
BOOST_FILESYSTEM_DECL
...
inline mars_boost::uintmax_t file_size(path const& p)
{
    return detail::file_size(p);
}

inline mars_boost::uintmax_t file_size(path const& p, system::error_code& ec) BOOST_NOEXCEPT
{
    return detail::file_size(p, &ec);
}

inline mars_boost::uintmax_t hard_link_count(path const& p)
{
    return detail::hard_link_count(p);
}

inline mars_boost::uintmax_t hard_link_count(path const& p, system::error_code& ec) BOOST_NOEXCEPT
{
...
inline mars_boost::uintmax_t remove_all(path const& p)
{
    return detail::remove_all(p);
}

inline mars_boost::uintmax_t remove_all(path const& p, system::error_code& ec) BOOST_NOEXCEPT
{
