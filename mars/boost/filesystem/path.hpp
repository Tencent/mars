...
public:
    ...
    template<
        typename Source,
        typename = typename mars_boost::enable_if_c<
            mars_boost::conjunction<
                detail::path_traits::is_path_source< typename mars_boost::remove_cv< Source >::type >,
                mars_boost::negation< detail::path_traits::is_native_path_source< typename mars_boost::remove_cv< Source >::type > >
            >::value
        >::type
    >
    ...
    path(Source const& source, typename mars_boost::enable_if_c<
        mars_boost::conjunction<
            detail::path_traits::is_path_source< typename mars_boost::remove_cv< Source >::type >,
            mars_boost::negation< detail::path_traits::is_native_path_source< typename mars_boost::remove_cv< Source >::type > >
        >::value
...
#else
    template< typename Source >
    explicit path(Source const& source, codecvt_type const& cvt, typename mars_boost::enable_if_c<
        mars_boost::conjunction<
            detail::path_traits::is_path_source< typename mars_boost::remove_cv< Source >::type >,
            mars_boost::negation< detail::path_traits::is_native_path_source< typename mars_boost::remove_cv< Source >::type > >
        >::value
    ...
    template<
        ...
        typename = typename mars_boost::enable_if_c<
            mars_boost::conjunction<
                ...
                mars_boost::negation< detail::path_traits::is_native_char_ptr< InputIterator > >
            >::value
        >::type
    >
    ...
    path(InputIterator begin, InputIterator end, typename mars_boost::enable_if_c<
        mars_boost::conjunction<
            detail::path_traits::is_path_source_iterator< InputIterator >,
            mars_boost::negation< detail::path_traits::is_native_char_ptr< InputIterator > >
        >::value
...
#else
    template< typename InputIterator >
    path(InputIterator begin, InputIterator end, codecvt_type const& cvt, typename mars_boost::enable_if_c<
        mars_boost::conjunction<
            detail::path_traits::is_path_source_iterator< InputIterator >,
            mars_boost::negation< detail::path_traits::is_native_char_ptr< InputIterator > >
        >::value
...
public:
    ...
    typename mars_boost::enable_if_c<
        mars_boost::disjunction<
            detail::path_traits::is_path_source< typename mars_boost::remove_cv< Source >::type >,
            detail::path_traits::is_convertible_to_path_source< typename mars_boost::remove_cv< Source >::type >
        >::value,
        path&
    ...
    template< typename Source >
    typename mars_boost::enable_if_c<
        detail::path_traits::is_path_source< typename mars_boost::remove_cv< Source >::type >::value,
        path&
    ...
    typename mars_boost::enable_if_c<
        mars_boost::conjunction<
            detail::path_traits::is_convertible_to_path_source< typename mars_boost::remove_cv< Source >::type >,
            mars_boost::negation< detail::path_traits::is_path_source< typename mars_boost::remove_cv< Source >::type > >
        >::value,
        path&
    >::type assign(Source const& source)
    {
    ...
    template< typename Source >
    typename mars_boost::enable_if_c<
        detail::path_traits::is_convertible_to_path_source< typename mars_boost::remove_cv< Source >::type >::value,
        path&
    >::type operator+=(Source const& source)
    {
...
private:
    ...
    friend struct mars_boost::filesystem::detail::path_algorithms;
...
inline typename mars_boost::enable_if_c<
    mars_boost::is_same< Path, path >::value,
    std::size_t
...
{
    return os << mars_boost::io::quoted(p.template string< std::basic_string< Char > >(), static_cast< Char >('&'));
}
