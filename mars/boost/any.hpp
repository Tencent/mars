...
/// \file boost/any.hpp
/// \brief \copybrief mars_boost::any
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost
{
    ...
    public:
            ...
            >(value))
        {
            static_assert(
                ...
                "mars_boost::any shall not be constructed from mars_boost::anys::basic_any"
            );
        }
    ...
    public: // modifiers
        ...
        any & operator=(ValueType&& rhs)
        {
            static_assert(
                !anys::detail::is_basic_any<typename std::decay<ValueType>::type>::value,
                "mars_boost::anys::basic_any shall not be assigned into mars_boost::any"
            );
    ...
    private: // types
        /// @cond
        class BOOST_SYMBOL_VISIBLE placeholder: public mars_boost::anys::detail::placeholder
        {
        public:
    ...
    private: // representation
        ...
        friend class mars_boost::anys::unique_any;
    ...
    {
        return mars_boost::unsafe_any_cast<ValueType>(const_cast<any *>(operand));
    }
    /// @endcond
    ...
    ValueType * any_cast(any * operand) noexcept
    {
        return operand && operand->type() == mars_boost::typeindex::type_id<ValueType>()
            ? mars_boost::unsafe_any_cast<typename std::remove_cv<ValueType>::type>(operand)
            : 0;
    }
    ...
    {
        return mars_boost::any_cast<ValueType>(const_cast<any *>(operand));
    }
    ...
    ValueType any_cast(any & operand)
    {
        ...
        nonref * result = mars_boost::any_cast<nonref>(std::addressof(operand));
        if(!result)
...
#   pragma warning(pop)
    ...
    {
        typedef typename std::remove_reference<ValueType>::type nonref;
        return mars_boost::any_cast<const nonref &>(const_cast<any &>(operand));
    }
    ...
    inline ValueType any_cast(any&& operand)
    {
        ...
        return mars_boost::any_cast<ValueType>(operand);
    }
}
