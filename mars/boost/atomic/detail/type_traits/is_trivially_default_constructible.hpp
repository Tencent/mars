...
template< typename T >
using is_trivially_default_constructible = mars_boost::has_trivial_constructor< T >;
#else
template< typename T >
struct is_trivially_default_constructible : public mars_boost::has_trivial_constructor< T > {};
#endif
