...
template< typename T >
using is_nothrow_default_constructible = mars_boost::has_nothrow_constructor< T >;
#else
template< typename T >
struct is_nothrow_default_constructible : public mars_boost::has_nothrow_constructor< T > {};
#endif
