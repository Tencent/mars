...
{
    return mars_boost::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return mars_boost::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return mars_boost::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return mars_boost::core::detail::copysign_impl( x, y );
}
