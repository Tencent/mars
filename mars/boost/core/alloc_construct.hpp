...
{
    mars_boost::allocator_destroy(a, p);
}
...
{
    mars_boost::allocator_destroy_n(a, p, n);
}
...
{
    mars_boost::allocator_construct(a, p);
}
...
{
    mars_boost::allocator_construct(a, p, std::forward<U>(u),
        std::forward<V>(v)...);
}
#else
...
{
    mars_boost::allocator_construct(a, p, u);
}
...
{
    mars_boost::allocator_construct_n(a, p, n);
}
...
{
    mars_boost::allocator_construct_n(a, p, n, l, m);
}
...
{
    mars_boost::allocator_construct_n(a, p, n, b);
}
