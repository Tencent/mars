...
//#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            ...
            if(res)
            {
                mars_boost::throw_exception(thread_resource_error(res, "mars_boost::condition_variable::condition_variable() constructor failed in pthread_mutex_init"));
            }
//#endif
...
//#endif
                mars_boost::throw_exception(thread_resource_error(res, "mars_boost::condition_variable::condition_variable() constructor failed in pthread_cond_init"));
            }
        }
        ~condition_variable()
        {
...
//#endif
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            ::mars_boost::xtime const& abs_time)
        {
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            ::mars_boost::xtime const& abs_time,predicate_type pred)
        {
