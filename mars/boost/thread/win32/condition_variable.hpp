...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost
{
    namespace detail
    {
        ...
        class basic_condition_variable
        {
            ...
            {
                mars_boost::lock_guard<mars_boost::mutex> lk(internal_mutex);
                if(!wake_sem)
                {
            ...
            struct entry_manager
            {
                ...
                entry_manager(entry_ptr&& entry_, mars_boost::mutex& mutex_):
                ...
                {
                  if (entry) {
                    mars_boost::lock_guard<mars_boost::mutex> internal_lock(internal_mutex);
                    entry->remove_waiter();
                    entry.reset();
                  }
                }
