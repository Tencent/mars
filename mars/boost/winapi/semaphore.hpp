...
BOOST_WINAPI_IMPORT mars_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC
CreateSemaphoreA(
    ::_SECURITY_ATTRIBUTES* lpSemaphoreAttributes,
    mars_boost::winapi::LONG_ lInitialCount,
    mars_boost::winapi::LONG_ lMaximumCount,
    mars_boost::winapi::LPCSTR_ lpName);
...
CreateSemaphoreW(
    ...
    mars_boost::winapi::LONG_ lInitialCount,
    mars_boost::winapi::LONG_ lMaximumCount,
    mars_boost::winapi::LPCWSTR_ lpName);
...
ReleaseSemaphore(
    mars_boost::winapi::HANDLE_ hSemaphore,
    mars_boost::winapi::LONG_ lReleaseCount,
    mars_boost::winapi::LPLONG_ lpPreviousCount);
