...
CryptEnumProvidersA(
    mars_boost::winapi::DWORD_ dwIndex,
    mars_boost::winapi::DWORD_ *pdwReserved,
    mars_boost::winapi::DWORD_ dwFlags,
    mars_boost::winapi::DWORD_ *pdwProvType,
    mars_boost::winapi::LPSTR_ szProvName,
    mars_boost::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextA(
    mars_boost::winapi::HCRYPTPROV_ *phProv,
    mars_boost::winapi::LPCSTR_ pszContainer,
    mars_boost::winapi::LPCSTR_ pszProvider,
    mars_boost::winapi::DWORD_ dwProvType,
    mars_boost::winapi::DWORD_ dwFlags);
...
CryptEnumProvidersW(
    ...
    mars_boost::winapi::DWORD_ dwFlags,
    mars_boost::winapi::DWORD_ *pdwProvType,
    mars_boost::winapi::LPWSTR_ szProvName,
    mars_boost::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextW(
    mars_boost::winapi::HCRYPTPROV_ *phProv,
    mars_boost::winapi::LPCWSTR_ szContainer,
    mars_boost::winapi::LPCWSTR_ szProvider,
    mars_boost::winapi::DWORD_ dwProvType,
    mars_boost::winapi::DWORD_ dwFlags);

BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptGenRandom(
    mars_boost::winapi::HCRYPTPROV_ hProv,
    mars_boost::winapi::DWORD_ dwLen,
    mars_boost::winapi::BYTE_ *pbBuffer);
...
CryptReleaseContext(
    mars_boost::winapi::HCRYPTPROV_ hProv,
    mars_boost::winapi::ULONG_PTR_ dwFlags);
#else
BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptReleaseContext(
    mars_boost::winapi::HCRYPTPROV_ hProv,
