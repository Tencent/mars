...
#endif // _WIN64
}} // namespace mars_boost::winapi

extern "C" {
#if !defined(UNDER_CE)
BOOST_WINAPI_IMPORT mars_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddress(mars_boost::winapi::HMODULE_ hModule, mars_boost::winapi::LPCSTR_ lpProcName);
#else
...
BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressA(mars_boost::winapi::HMODULE_ hModule, mars_boost::winapi::LPCSTR_ lpProcName);
BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressW(mars_boost::winapi::HMODULE_ hModule, mars_boost::winapi::LPCWSTR_ lpProcName);
#endif
} // extern "C"
