...
MultiByteToWideChar(
    mars_boost::winapi::UINT_ CodePage,
    mars_boost::winapi::DWORD_ dwFlags,
    mars_boost::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
    mars_boost::winapi::LPWSTR_ lpWideCharStr,
    int cchWideChar);
...
WideCharToMultiByte(
    mars_boost::winapi::UINT_ CodePage,
    mars_boost::winapi::DWORD_ dwFlags,
    mars_boost::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    mars_boost::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    mars_boost::winapi::LPCSTR_ lpDefaultChar,
    mars_boost::winapi::LPBOOL_ lpUsedDefaultChar);
