...
BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(mars_boost::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(mars_boost::winapi::detail::winsdk_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(mars_boost::winapi::detail::winsdk_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
#if BOOST_WINAPI_PARTITION_APP_SYSTEM
BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    mars_boost::winapi::detail::winsdk_critical_section* lpCriticalSection,
    mars_boost::winapi::DWORD_ dwSpinCount);
...
InitializeCriticalSectionEx(
    mars_boost::winapi::detail::winsdk_critical_section* lpCriticalSection,
    mars_boost::winapi::DWORD_ dwSpinCount,
    mars_boost::winapi::DWORD_ Flags);
#endif
#endif

#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(mars_boost::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(mars_boost::winapi::detail::winsdk_critical_section* lpCriticalSection);

#else // defined( BOOST_WINAPI_IS_MINGW )

BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(mars_boost::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(mars_boost::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(mars_boost::winapi::detail::winapi_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    mars_boost::winapi::detail::winapi_critical_section* lpCriticalSection,
    mars_boost::winapi::DWORD_ dwSpinCount);
...
#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(mars_boost::winapi::detail::winapi_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(mars_boost::winapi::detail::winapi_critical_section* lpCriticalSection);
