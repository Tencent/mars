...
FormatMessageA(
    ...
    mars_boost::winapi::LPCVOID_ lpSource,
    mars_boost::winapi::DWORD_ dwMessageId,
    mars_boost::winapi::DWORD_ dwLanguageId,
    mars_boost::winapi::LPSTR_ lpBuffer,
...
FormatMessageW(
    ...
    mars_boost::winapi::DWORD_ dwMessageId,
    mars_boost::winapi::DWORD_ dwLanguageId,
    mars_boost::winapi::LPWSTR_ lpBuffer,
    mars_boost::winapi::DWORD_ nSize,
    va_list *Arguments);

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_WINAPI_IMPORT mars_boost::winapi::UINT_ BOOST_WINAPI_WINAPI_CC
SetErrorMode(mars_boost::winapi::UINT_ uMode);
#endif
} // extern "C"
#endif
