...
CreateEventA(
    ...
    mars_boost::winapi::BOOL_ bManualReset,
    mars_boost::winapi::BOOL_ bInitialState,
...
SetEvent(mars_boost::winapi::HANDLE_ hEvent);

BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
ResetEvent(mars_boost::winapi::HANDLE_ hEvent);
#endif
} // extern "C"
#endif
