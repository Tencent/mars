...
typedef mars_boost::winapi::VOID_ (BOOST_WINAPI_NTAPI_CC *WAITORTIMERCALLBACKFUNC)
    (mars_boost::winapi::PVOID_, mars_boost::winapi::BOOLEAN_);
typedef WAITORTIMERCALLBACKFUNC WAITORTIMERCALLBACK;

BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
RegisterWaitForSingleObject(
    mars_boost::winapi::PHANDLE_ phNewWaitObject,
    mars_boost::winapi::HANDLE_ hObject,
    WAITORTIMERCALLBACK Callback,
    mars_boost::winapi::PVOID_ Context,
    mars_boost::winapi::ULONG_ dwMilliseconds,
...
#if BOOST_WINAPI_PARTITION_DESKTOP
BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWait(mars_boost::winapi::HANDLE_ WaitHandle);
#endif

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_WINAPI_IMPORT mars_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWaitEx(
    mars_boost::winapi::HANDLE_ WaitHandle,
    mars_boost::winapi::HANDLE_ CompletionEvent);
#endif
} // extern "C"
#endif
