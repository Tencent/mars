...
BOOST_WINAPI_IMPORT mars_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
...
BOOST_WINAPI_IMPORT mars_boost::winapi::ULONGLONG_ BOOST_WINAPI_WINAPI_CC
...
{
    mars_boost::winapi::SYSTEMTIME_ st;
    mars_boost::winapi::GetSystemTime(&st);
    mars_boost::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
