...
private:
    ...
    mars_boost::system::error_category const * pc_;

public:

    mars_boost::system::error_category const & original_category() const BOOST_NOEXCEPT
    {
        return *pc_;
    }
...
public:
    ...
    explicit std_category( mars_boost::system::error_category const * pc, id_wrapper<Id> ): pc_( pc )
    {
