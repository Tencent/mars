...
inline mars_boost::system::error_condition mars_boost::system::detail::system_error_category::default_error_condition( int ev ) const BOOST_NOEXCEPT
{
    ...
    {
        return error_condition( mars_boost::system::detail::generic_value_tag( e2 ) );
    }
}
...
inline mars_boost::system::error_condition mars_boost::system::detail::system_error_category::default_error_condition( int ev ) const BOOST_NOEXCEPT
{
    return error_condition( mars_boost::system::detail::generic_value_tag( ev ) );
}

#endif // #if defined(BOOST_WINDOWS_API)

inline std::string mars_boost::system::detail::system_error_category::message( int ev ) const
{
    return system_error_category_message( ev );
}

inline char const * mars_boost::system::detail::system_error_category::message( int ev, char * buffer, std::size_t len ) const BOOST_NOEXCEPT
{
