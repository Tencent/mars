...
{
    static_assert( sizeof( stdcat_ ) >= sizeof( mars_boost::system::detail::std_category ), "sizeof(stdcat_) is not enough for std_category" );

#if defined(BOOST_MSVC) && BOOST_MSVC < 1900
    // no alignof
#else

    static_assert( alignof( decltype(stdcat_align_) ) >= alignof( mars_boost::system::detail::std_category ), "alignof(stdcat_) is not enough for std_category" );
    ...
    {
        ::new( static_cast<void*>( stdcat_ ) ) mars_boost::system::detail::std_category( this, system::detail::id_wrapper<0>() );
...
// This condition must be the same as the one in error_condition.hpp
        ...
        static const mars_boost::system::detail::std_category generic_instance( this, system::detail::id_wrapper<0x1F4D3>() );
...
// This condition must be the same as the one in error_code.hpp
        ...
        static const mars_boost::system::detail::std_category system_instance( this, system::detail::id_wrapper<0x1F4D7>() );
    ...
    return *static_cast<mars_boost::system::detail::std_category const*>( static_cast<void const*>( stdcat_ ) );
}
