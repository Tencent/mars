...
template< class E, class Y > inline void lsp_pointer_construct( mars_boost::local_shared_ptr< E > * /*ppx*/, Y * p, mars_boost::detail::local_counted_base * & pn )
{
    mars_boost::detail::sp_assert_convertible< Y, E >();

    typedef mars_boost::detail::local_sp_deleter< mars_boost::checked_deleter<Y> > D;

    mars_boost::shared_ptr<E> p2( p, D() );
...
template< class E, class Y > inline void lsp_pointer_construct( mars_boost::local_shared_ptr< E[] > * /*ppx*/, Y * p, mars_boost::detail::local_counted_base * & pn )
{
    ...
    typedef mars_boost::detail::local_sp_deleter< mars_boost::checked_array_deleter<E> > D;
...
template< class E, std::size_t N, class Y > inline void lsp_pointer_construct( mars_boost::local_shared_ptr< E[N] > * /*ppx*/, Y * p, mars_boost::detail::local_counted_base * & pn )
{
    mars_boost::detail::sp_assert_convertible< Y[N], E[N] >();

    typedef mars_boost::detail::local_sp_deleter< mars_boost::checked_array_deleter<E> > D;

    mars_boost::shared_ptr<E[N]> p2( p, D() );
...
template< class E, class P, class D > inline void lsp_deleter_construct( mars_boost::local_shared_ptr< E > * /*ppx*/, P p, D const& d, mars_boost::detail::local_counted_base * & pn )
{
    typedef mars_boost::detail::local_sp_deleter<D> D2;

    mars_boost::shared_ptr<E> p2( p, D2( d ) );
...
template< class E, class P, class D, class A > inline void lsp_allocator_construct( mars_boost::local_shared_ptr< E > * /*ppx*/, P p, D const& d, A const& a, mars_boost::detail::local_counted_base * & pn )
{
    typedef mars_boost::detail::local_sp_deleter<D> D2;

    mars_boost::shared_ptr<E> p2( p, D2( d ), a );
...
private:
    ...
    element_type * px;
    mars_boost::detail::local_counted_base * pn;
...
public:
    ...
    BOOST_CONSTEXPR local_shared_ptr( mars_boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT : px( 0 ), pn( 0 )
    {
    }
    ...
    BOOST_CONSTEXPR local_shared_ptr( mars_boost::detail::lsp_internal_constructor_tag, element_type * px_, mars_boost::detail::local_counted_base * pn_ ) BOOST_SP_NOEXCEPT : px( px_ ), pn( pn_ )
    {
    }
    ...
    {
        mars_boost::detail::lsp_pointer_construct( this, p, pn );
    }

    template<class Y, class D> local_shared_ptr( Y * p, D d ): px( p ), pn( 0 )
    {
        mars_boost::detail::lsp_deleter_construct( this, p, d, pn );
    }

#if !defined( BOOST_NO_CXX11_NULLPTR )

    template<class D> local_shared_ptr( mars_boost::detail::sp_nullptr_t p, D d ): px( p ), pn( 0 )
    {
        mars_boost::detail::lsp_deleter_construct( this, p, d, pn );
    }
    ...
    {
        mars_boost::detail::lsp_allocator_construct( this, p, d, a, pn );
    }

#if !defined( BOOST_NO_CXX11_NULLPTR )

    template<class D, class A> local_shared_ptr( mars_boost::detail::sp_nullptr_t p, D d, A a ): px( p ), pn( 0 )
    {
        mars_boost::detail::lsp_allocator_construct( this, p, d, a, pn );
    }
    ...
    template<class Y> local_shared_ptr( shared_ptr<Y> const & r,
        typename mars_boost::detail::sp_enable_if_convertible<Y, T>::type = mars_boost::detail::sp_empty() )
        : px( r.get() ), pn( 0 )
    {
        ...
        if( r.use_count() != 0 )
        {
            pn = new mars_boost::detail::local_counted_impl( r._internal_count() );
        }
    }
        ...
        : px( r.get() ), pn( 0 )
    {
        ...
        if( px )
        {
            pn = new mars_boost::detail::local_counted_impl( shared_ptr<T>( std::move(r) )._internal_count() );
        }
    }
    ...
    template< class Y, class D >
    local_shared_ptr( mars_boost::movelib::unique_ptr< Y, D > r ); // !
    //  : px( r.get() ), pn( new mars_boost::detail::local_counted_impl( shared_ptr<T>( std::move(r) ) ) )
    //{
    //    mars_boost::detail::sp_assert_convertible< Y, T >();
    //}
    ...
    template<class Y> local_shared_ptr( local_shared_ptr<Y> const & r,
        typename mars_boost::detail::sp_enable_if_convertible<Y, T>::type = mars_boost::detail::sp_empty() ) BOOST_SP_NOEXCEPT
        : px( r.px ), pn( r.pn )
    {
        mars_boost::detail::sp_assert_convertible< Y, T >();
    ...
    local_shared_ptr & operator=( mars_boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT
    {
    ...
    template<class Y, class D>
    local_shared_ptr & operator=( mars_boost::movelib::unique_ptr<Y, D> r ); // !
    ...
    typename mars_boost::detail::sp_dereference< T >::type operator* () const BOOST_SP_NOEXCEPT
    {
        return *px;
    }

    typename mars_boost::detail::sp_member_access< T >::type operator-> () const BOOST_SP_NOEXCEPT
    {
        return px;
    }

    typename mars_boost::detail::sp_array_access< T >::type operator[] ( std::ptrdiff_t i ) const BOOST_SP_NOEXCEPT_WITH_ASSERT
    {
        BOOST_ASSERT( px != 0 );
...
#include <boost/smart_ptr/detail/operator_bool.hpp>
    ...
    template<class Y, class E = typename mars_boost::detail::sp_enable_if_convertible<T,Y>::type> operator shared_ptr<Y>() const BOOST_SP_NOEXCEPT
#else
    template<class Y> operator shared_ptr<Y>() const BOOST_SP_NOEXCEPT
#endif
    {
        mars_boost::detail::sp_assert_convertible<T, Y>();

        if( pn )
        {
            return shared_ptr<Y>( mars_boost::detail::sp_internal_constructor_tag(), px, pn->local_cb_get_shared_count() );
        }
        else
        {
            return shared_ptr<Y>();
...
#if !defined( BOOST_SP_NO_SP_CONVERTIBLE ) && !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
    template<class Y, class E = typename mars_boost::detail::sp_enable_if_convertible<T,Y>::type> operator weak_ptr<Y>() const BOOST_SP_NOEXCEPT
#else
    ...
    {
        return std::less< mars_boost::detail::local_counted_base* >()( pn, r.pn );
    }
...
template<class T> inline bool operator==( local_shared_ptr<T> const & p, mars_boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( mars_boost::detail::sp_nullptr_t, local_shared_ptr<T> const & p ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}
...
// get_pointer() enables mars_boost::mem_fn to recognize local_shared_ptr
...
{
    return mars_boost::hash< typename local_shared_ptr<T>::element_type* >()( p.get() );
}
...
template<class T> struct hash< ::mars_boost::local_shared_ptr<T> >
{
    std::size_t operator()( ::mars_boost::local_shared_ptr<T> const & p ) const BOOST_SP_NOEXCEPT
    {
        return std::hash< typename ::mars_boost::local_shared_ptr<T>::element_type* >()( p.get() );
    }
};
