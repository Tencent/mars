...
private:
    ...
    mars_boost::shared_ptr<T> p_;

    mutable mars_boost::detail::spinlock l_;
...
public:
    ...
    {
        mars_boost::detail::spinlock init = BOOST_DETAIL_SPINLOCK_INIT;
    ...
    {
        mars_boost::detail::spinlock::scoped_lock lock( l_ );
        p_.swap( r );
