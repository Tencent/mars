...
extern "C" void * mars_boostlw_thread_routine( void * pv )
{
...
unsigned __stdcall mars_boostlw_thread_routine( void * pv )
{
#if defined(BOOST_NO_CXX11_SMART_PTR)
...
template<class F> int lw_thread_create( lw_thread_t & th, F f )
{
    ...
    int r = lw_thread_create_( &th, 0, mars_boostlw_thread_routine, p.get() );
