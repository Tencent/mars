...
inline void atomic_increment( mars_boost::uint_least32_t * pw )
{
    __atomic_fetch_add( pw, 1, __ATOMIC_RELAXED );
}

inline mars_boost::uint_least32_t atomic_decrement( mars_boost::uint_least32_t * pw )
{
    return __atomic_fetch_sub( pw, 1, __ATOMIC_ACQ_REL );
}

inline mars_boost::uint_least32_t atomic_conditional_increment( mars_boost::uint_least32_t * pw )
{
    // long r = *pw;
    // if( r != 0 ) ++*pw;
    // return r;

    mars_boost::uint_least32_t r = __atomic_load_n( pw, __ATOMIC_RELAXED );
...
inline mars_boost::uint_least32_t atomic_load( mars_boost::uint_least32_t const * pw )
{
...
private:
    ...
    mars_boost::uint_least32_t use_count_;        // #shared
    mars_boost::uint_least32_t weak_count_;       // #weak + (#shared != 0)
