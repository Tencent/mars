...
struct thread_safe_counter
{
    ...
    static unsigned int load(mars_boost::detail::atomic_count const& counter) BOOST_SP_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(mars_boost::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(mars_boost::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
