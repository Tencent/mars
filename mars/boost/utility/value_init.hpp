...
// Note: The implementation of mars_boost::value_initialized had to deal with the
// fact that various compilers haven't fully implemented value-initialization.
// The constructor of mars_boost::value_initialized<T> works around these compiler
...
#endif
{
  ...
  public :
    ...
    {
      ::mars_boost::core::invoke_swap( this->data(), arg.data() );
    }
