...
struct resolve_traits {
    typedef typename 
            mpl::if_<
                mars_boost::detail::is_incrementable<T>,
...
range_adapter< Mode, mars_boost::iterator_range<Iter> >
resolve(const mars_boost::iterator_range<Iter>& rng)
{ return range_adapter< Mode, mars_boost::iterator_range<Iter> >(rng); }
