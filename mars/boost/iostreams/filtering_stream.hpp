...
class filtering_stream_base 
    : public access_control<
                 mars_boost::iostreams::detail::chain_client<Chain>,
                 Access
             >,
...
#define BOOST_IOSTREAMS_DEFINE_FILTER_STREAM(name_, chain_type_, default_char_) \
    ...
    class name_ \
        : public mars_boost::iostreams::detail::filtering_stream_base< \
    ...
    private: \
        typedef access_control< \
                    mars_boost::iostreams::detail::chain_client< \
...
BOOST_IOSTREAMS_DEFINE_FILTER_STREAM(filtering_stream, mars_boost::iostreams::chain, char)
BOOST_IOSTREAMS_DEFINE_FILTER_STREAM(wfiltering_stream, mars_boost::iostreams::chain, wchar_t)
