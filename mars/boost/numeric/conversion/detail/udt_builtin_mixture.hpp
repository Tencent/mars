...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace numeric { namespace convdetail
{
  ...
  typedef mars_boost::integral_constant<udt_builtin_mixture_enum, builtin_to_builtin> builtin2builtin_c ;
  typedef mars_boost::integral_constant<udt_builtin_mixture_enum, builtin_to_udt>     builtin2udt_c ;
  typedef mars_boost::integral_constant<udt_builtin_mixture_enum, udt_to_builtin>     udt2builtin_c ;
  typedef mars_boost::integral_constant<udt_builtin_mixture_enum, udt_to_udt>         udt2udt_c ;
