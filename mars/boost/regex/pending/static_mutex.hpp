...
// because mars_boost::call_once doesn't alow us to pass instance information
...
public:
   typedef scoped_static_mutex_lock scoped_lock;
   static void init();
   static mars_boost::recursive_mutex* m_pmutex;
   static mars_boost::once_flag m_once;
};
...
public:
   ...
   void unlock();
private:
   mars_boost::unique_lock<mars_boost::recursive_mutex>* m_plock;
   bool m_have_lock;
};
