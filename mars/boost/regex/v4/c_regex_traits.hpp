...
struct c_regex_traits<char>
{
   ...
   struct locale_type{};
   typedef mars_boost::uint32_t char_class_type;
...
{
   static char s_delim;
   static const int s_collate_type = ::mars_boost::BOOST_REGEX_DETAIL_NS::find_sort_syntax(static_cast<c_regex_traits<char>*>(0), &s_delim);
   std::string result;
   //
   ...
   {
   case ::mars_boost::BOOST_REGEX_DETAIL_NS::sort_C:
   case ::mars_boost::BOOST_REGEX_DETAIL_NS::sort_unknown:
   ...
   case ::mars_boost::BOOST_REGEX_DETAIL_NS::sort_fixed:
   {
   ...
   case ::mars_boost::BOOST_REGEX_DETAIL_NS::sort_delim:
...
inline c_regex_traits<char>::char_class_type BOOST_REGEX_CALL c_regex_traits<char>::lookup_classname(const char* p1, const char* p2)
{
   ...
   int idx = ::mars_boost::BOOST_REGEX_DETAIL_NS::get_default_class_id(p1, p2);
   if (idx < 0)
   {
      std::string s(p1, p2);
      for (std::string::size_type i = 0; i < s.size(); ++i)
         s[i] = static_cast<char>((std::tolower)(static_cast<unsigned char>(s[i])));
      idx = ::mars_boost::BOOST_REGEX_DETAIL_NS::get_default_class_id(&*s.begin(), &*s.begin() + s.size());
   }
...
inline bool BOOST_REGEX_CALL c_regex_traits<char>::isctype(char c, char_class_type mask)
{
   ...
   return
      ...
      || ((mask & char_class_blank) && (std::isspace)(static_cast<unsigned char>(c)) && !::mars_boost::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & char_class_word) && (c == '_'))
      || ((mask & char_class_vertical) && (::mars_boost::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == '\v')))
      || ((mask & char_class_horizontal) && (std::isspace)(static_cast<unsigned char>(c)) && !::mars_boost::BOOST_REGEX_DETAIL_NS::is_separator(c) && (c != '\v'));
}
...
{
   std::string s(p1, p2);
   s = ::mars_boost::BOOST_REGEX_DETAIL_NS::lookup_default_collate_name(s);
   if (s.empty() && (p2 - p1 == 1))
      s.append(1, *p1);
   return s;
}
...
inline c_regex_traits<wchar_t>::string_type BOOST_REGEX_CALL c_regex_traits<wchar_t>::transform_primary(const wchar_t* p1, const wchar_t* p2)
{
   ...
   static const int s_collate_type = ::mars_boost::BOOST_REGEX_DETAIL_NS::find_sort_syntax(static_cast<const c_regex_traits<wchar_t>*>(0), &s_delim);
   std::wstring result;
   //
   // What we do here depends upon the format of the sort key returned by
   // sort key returned by this->transform:
...
inline bool BOOST_REGEX_CALL c_regex_traits<wchar_t>::isctype(wchar_t c, char_class_type mask)
{
   ...
   return
      ...
      || ((mask & char_class_blank) && (std::iswspace)(c) && !::mars_boost::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & char_class_word) && (c == '_'))
      || ((mask & char_class_unicode) && (c & ~static_cast<wchar_t>(0xff)))
      || ((mask & char_class_vertical) && (::mars_boost::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == L'\v')))
      || ((mask & char_class_horizontal) && (std::iswspace)(c) && !::mars_boost::BOOST_REGEX_DETAIL_NS::is_separator(c) && (c != L'\v'));
}
...
#pragma warning(pop)
#endif
   name = ::mars_boost::BOOST_REGEX_DETAIL_NS::lookup_default_collate_name(name);
   if (!name.empty())
