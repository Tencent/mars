...
public:
   ...
   typedef typename mars_boost::make_unsigned<native_mask_type>::type  unsigned_native_mask_type;
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_alnum,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_alpha,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_cntrl,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_digit,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_graph,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_lower,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_print,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_punct,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_space,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_upper,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_blank,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_word,
         ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_upper,
      ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
      ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::mars_boost::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_word) && (c == '_'))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_unicode) && ::mars_boost::BOOST_REGEX_DETAIL_NS::is_extended(c))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::mars_boost::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline mars_boost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l)
{
   cpp_regex_traits_base<charT> key(l);
   return ::mars_boost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
private:
   mars_boost::shared_ptr<const BOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
...
template <class charT>
mars_boost::intmax_t cpp_regex_traits<charT>::toi(const charT*& first, const charT* last, int radix)const
{
