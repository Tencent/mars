...
//
typedef ::mars_boost::uint32_t lcid_type;   // placeholder for LCID.
typedef ::mars_boost::shared_ptr<void> cat_type; // placeholder for dll HANDLE.
...
#endif
bool BOOST_REGEX_CALL w32_is(lcid_type, mars_boost::uint32_t mask, char c);
#ifndef BOOST_NO_WREGEX
bool BOOST_REGEX_CALL w32_is(lcid_type, mars_boost::uint32_t mask, wchar_t c);
#endif
//
...
public:
   ...
   bool isctype(mars_boost::uint32_t mask, charT c)const
   {
...
public:
   ...
   bool isctype(mars_boost::uint32_t mask, char c)const
   {
...
private:
   ...
   mars_boost::uint16_t m_type_map[1u << CHAR_BIT];
   template <class U>
   void init();
};
...
template <class charT>
mars_boost::shared_ptr<const w32_regex_traits_implementation<charT> > create_w32_regex_traits(::mars_boost::BOOST_REGEX_DETAIL_NS::lcid_type l)
{
...
public:
   ...
   typedef mars_boost::uint_least32_t         char_class_type;
   ...
   mars_boost::intmax_t toi(const charT*& p1, const charT* p2, int radix)const
   {
...
private:
   mars_boost::shared_ptr<const BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT> > m_pimpl;
   //
...
#endif
   inline bool BOOST_REGEX_CALL w32_is(lcid_type idx, mars_boost::uint32_t m, char c)
   {
      WORD mask;
#ifndef BOOST_NO_ANSI_APIS
...
#ifndef BOOST_NO_WREGEX
   inline bool BOOST_REGEX_CALL w32_is(lcid_type idx, mars_boost::uint32_t m, wchar_t c)
   {
      WORD mask;
