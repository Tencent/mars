...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost
{
        ...
        hash_value( T v )
    {
        ...
        //
        // mars_boost::hash_value( to_underlying(v) );
        //
    ...
    typename std::enable_if<std::is_floating_point<T>::value, std::size_t>::type
        hash_value( T v )
    {
        return mars_boost::hash_detail::hash_float_impl<T>::fn( v + 0 );
    }
    ...
    template <class T> std::size_t hash_value( T* const& v )
    {
        ...
        return mars_boost::hash_value( x + (x >> 3) );
    }
    ...
    {
        return mars_boost::hash_range( x, x + N );
    }
    ...
    {
        std::size_t re = mars_boost::hash<T>()( v.real() );
        std::size_t im = mars_boost::hash<T>()( v.imag() );
    ...
    typename std::enable_if<container_hash::is_contiguous_range<T>::value, std::size_t>::type
        hash_value( T const& v )
    {
        return mars_boost::hash_range( v.data(), v.data() + v.size() );
    }
    ...
    typename std::enable_if<container_hash::is_unordered_range<T>::value, std::size_t>::type
        hash_value( T const& v )
    {
        return mars_boost::hash_unordered_range( v.begin(), v.end() );
    }
...
# pragma warning(disable: 4100) // unreferenced formal parameter
        ...
        hash_value( T const& v )
    {
        ...
        mp11::mp_for_each<Bd>([&](auto D){
            ...
            mars_boost::hash_combine( r, (B const&)v );
        ...
        mp11::mp_for_each<Md>([&](auto D){
            ...
            mars_boost::hash_combine( r, v.*D.pointer );
...
# pragma warning(pop)
    ...
    inline std::size_t hash_value( std::error_code const& v )
    {
        ...
        mars_boost::hash_combine( seed, v.value() );
        mars_boost::hash_combine( seed, &v.category() );
    ...
    typename std::enable_if<std::is_same<T, std::nullptr_t>::value, std::size_t>::type
        hash_value( T const& /*v*/ )
    {
        return mars_boost::hash_value( static_cast<void*>( nullptr ) );
    }
    ...
    //
    // mars_boost::hash_combine
    //

    template <class T>
    inline void hash_combine( std::size_t& seed, T const& v )
    {
        seed = mars_boost::hash_detail::hash_mix( seed + 0x9e3779b9 + mars_boost::hash<T>()( v ) );
    }

    //
    // mars_boost::hash_range
    //
    ...
    //
    // mars_boost::hash_unordered_range
    //
    ...
    // mars_boost::unordered::hash_is_avalanching

    namespace unordered
    {
        template<class T> struct hash_is_avalanching;
        template<class Ch> struct hash_is_avalanching< mars_boost::hash< std::basic_string<Ch> > >: std::is_integral<Ch> {};

#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)

        template<class Ch> struct hash_is_avalanching< mars_boost::hash< std::basic_string_view<Ch> > >: std::is_integral<Ch> {};
