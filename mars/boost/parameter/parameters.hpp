...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    struct arg_list_factory<ArgList,A0,Args...>
    {
        ...
        {
            return ::mars_boost::parameter::aux
...
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mars_boost::mp11::mp_list
#else
...
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mars_boost::fusion::list
#else
...
#include <boost/fusion/mpl.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mars_boost::fusion::deque
#else
#include <boost/mpl/vector.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::mars_boost::mpl::vector
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter {
    ...
    struct parameters
    {
...
#if !defined(BOOST_PARAMETER_CAN_USE_MP11)
          : ::mars_boost::mpl::if_<
                typename ::mars_boost::parameter::aux::match_parameters_base_cond<
                    ArgumentPackAndError
                  , parameter_spec
                >::type
              , ::mars_boost::mpl::identity<
                    ::mars_boost::parameter::parameters<Spec...>
                >
              , ::mars_boost::parameter::void_
            >
#endif
        ...
        struct match
          : ::mars_boost::parameter::parameters<Spec...>
            ::BOOST_NESTED_TEMPLATE match_base<
                typename ::mars_boost::parameter::aux::make_arg_list<
        ...
        struct bind
#if !defined(BOOST_PARAMETER_CAN_USE_MP11)
          : ::mars_boost::mpl::first<
                typename ::mars_boost::parameter::aux::make_arg_list<
                    typename ::mars_boost::parameter::aux
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
                  , ::mars_boost::parameter::aux::tag_template_keyword_arg
                >::type
            >
#endif
        {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            using type = ::mars_boost::mp11::mp_at_c<
                typename ::mars_boost::parameter::aux::make_arg_list<
                    typename ::mars_boost::parameter::aux
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
        ...
        inline ::mars_boost::parameter::aux::empty_arg_list operator()() const
        {
            return ::mars_boost::parameter::aux::empty_arg_list();
        }

        template <typename A0, typename ...Args>
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        inline ::mars_boost::mp11::mp_at_c<
#else
        inline typename ::mars_boost::mpl::first<
#endif
            typename ::mars_boost::parameter::aux::make_arg_list<
                typename ::mars_boost::parameter::aux
        ...
        {
            typedef typename ::mars_boost::parameter::aux::make_arg_list<
                typename ::mars_boost::parameter::aux
                ::make_parameter_spec_items<parameter_spec,A0,Args...>::type
              , deduced_list
              , ::mars_boost::parameter::aux::tag_keyword_arg
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            using result_type = ::mars_boost::mp11::mp_at_c<list_error_pair,0>;

            using error = ::mars_boost::mp11::mp_at_c<list_error_pair,1>;
#else
            typedef typename ::mars_boost::mpl
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter {
    ...
    !BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x592))
...
#else
        {
            typedef ::mars_boost::parameter::parameters<
                BOOST_PP_ENUM_PARAMS(BOOST_PARAMETER_MAX_ARITY, PS)
            > type;
        };
#endif  // SFINAE enabled, not Borland
        ...
        struct bind
        {
            ...
            typedef typename ::mars_boost::mpl::first<result>::type type;
        };
...
#include BOOST_PP_ITERATE()
        ...
        inline typename ::mars_boost::mpl::first<
            typename ::mars_boost::parameter::aux::make_arg_list<
                ...
                >
              , deduced_list
              , ::mars_boost::parameter::aux::tag_keyword_arg_ref
            >::type
        >::type
