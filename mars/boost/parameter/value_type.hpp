...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter {
    ...
    struct value_type0
    {
        ...
        using type = ::mars_boost::mp11::mp_apply_q<
          ...
          , ::mars_boost::mp11::mp_list<Keyword,Default,::mars_boost::mp11::mp_false>
        >;

        static_assert(
            ::mars_boost::mp11::mp_if<
                ::std::is_same<Default,::mars_boost::parameter::void_>
              , ::mars_boost::mp11::mp_if<
                    ::std::is_same<type,::mars_boost::parameter::void_>
        ...
        BOOST_MPL_ASSERT((
            typename ::mars_boost::mpl::eval_if<
                ::mars_boost::is_same<Default,::mars_boost::parameter::void_>
              , ::mars_boost::mpl::if_<
                    ::mars_boost::is_same<type,::mars_boost::parameter::void_>
                  , ::mars_boost::mpl::false_
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter {
    ...
    template <
        typename Parameters
      , typename Keyword
      , typename Default = ::mars_boost::parameter::void_
    >
    struct value_type
#if !defined(BOOST_PARAMETER_CAN_USE_MP11)
      : ::mars_boost::mpl::eval_if<
            ::mars_boost::parameter::aux::is_mpl_placeholder<Parameters>
          , ::mars_boost::mpl::identity<int>
          , ::mars_boost::parameter::value_type0<Parameters,Keyword,Default>
        >
#endif
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = typename ::mars_boost::mp11::mp_if<
            ::mars_boost::parameter::aux::is_mpl_placeholder<Parameters>
          , ::mars_boost::mp11::mp_identity<int>
          , ::mars_boost::mp11::mp_if<
                ::mars_boost::parameter::aux::is_mp11_placeholder<Parameters>
              , ::mars_boost::parameter::value_type1<Parameters,Keyword,Default>
              , ::mars_boost::parameter::value_type0<Parameters,Keyword,Default>
            >
        >::type;
#endif
    ...
    struct lazy_value_type
    {
        ...
        using type = ::mars_boost::mp11::mp_apply_q<
          ...
          , ::mars_boost::mp11::mp_list<
                Keyword
              , typename ::mars_boost::parameter::aux::result_of0<DefaultFn>::type
              , ::mars_boost::mp11::mp_false
            >
        >;
#else
