...
//         , ... mars_boost::mpl::identity<mars_boost::parameter::aux::empty_arg_list>
//    ...>
//   >
...
#define BOOST_PARAMETER_template_args(z, n, prefix)                          \
    typename BOOST_PP_CAT(prefix, n) = ::mars_boost::parameter::void_
/**/
...
#define BOOST_PARAMETER_make_arg_items_R(r, prefix, i, elem)                 \
    ::mars_boost::parameter::aux::item<BOOST_PP_CAT(prefix, i),                   \
