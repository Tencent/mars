...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    template <typename KW, typename DefaultComputer>
    struct lazy_default
      : ::mars_boost::parameter::aux::lazy_default_base<KW,DefaultComputer>
    {
        inline BOOST_CONSTEXPR lazy_default(DefaultComputer& x)
          : ::mars_boost::parameter::aux::lazy_default_base<KW,DefaultComputer>(x)
        {
        }
    };
...
#define BOOST_PARAMETER_lazy_default_fallback \
    ::mars_boost::parameter::aux::lazy_default_base
/**/
#else
#define BOOST_PARAMETER_lazy_default_fallback \
    ::mars_boost::parameter::aux::lazy_default
/**/
#endif
