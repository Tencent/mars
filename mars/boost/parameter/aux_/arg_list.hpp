...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        struct tagged_arg
        {
            typedef ::mars_boost::parameter::void_ value_type;
        };
        ...
        static ::mars_boost::parameter::aux::no_tag has_key(KW*);
        ...
        inline BOOST_CONSTEXPR Default&
            operator[](::mars_boost::parameter::aux::default_<K,Default> x) const
        {
            return x.value;
        }
        ...
        template <typename K, typename Default>
        inline BOOST_CONSTEXPR Default&&
            operator[](::mars_boost::parameter::aux::default_r_<K,Default> x) const
        {
        ...
        // MPL sequence support
        typedef ::mars_boost::parameter::aux::empty_arg_list type; // convenience
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    template <
        typename TaggedArg
      , typename Next = ::mars_boost::parameter::aux::empty_arg_list
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    ...
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _holds_maybe = typename ::mars_boost::parameter::aux
     ...
     public:
        ...
        typedef ::mars_boost::parameter::aux::arg_list<TaggedArg,Next> self;
        typedef typename TaggedArg::key_type key_type;

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::mars_boost::mp11::mp_if<
            _holds_maybe
          , ::mars_boost::parameter::aux
            ::get_reference<typename TaggedArg::value_type>
          , ::mars_boost::parameter::aux::get_reference<TaggedArg>
        >::type;

        using value_type = ::mars_boost::mp11
        ...
        inline BOOST_CONSTEXPR arg_list(
            ::mars_boost::parameter::aux::value_type_is_not_void
          , A0&& a0
        ) : Next(
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                ...
                typename ::mars_boost::mpl::if_<
                    ...
                    >
                  , ::mars_boost::parameter::aux::value_type_is_void
                  , ::mars_boost::parameter::aux::value_type_is_not_void
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                >()
#else
        ...
        inline BOOST_CONSTEXPR arg_list(
          ...
          , arg(::mars_boost::parameter::aux::void_reference())
        {
        }
        ...
        struct binding
        {
            ...
            using fn = ::mars_boost::mp11::mp_if<
              ...
              , ::mars_boost::mp11::mp_apply_q<
                    next_binding
                  , ::mars_boost::mp11::mp_list<KW,Default,Reference>
                >
            >;
#endif
        };
        ...
        static ::mars_boost::parameter::aux::yes_tag has_key(key_type*);
        using Next::has_key;

     private:
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _has_unique_key = ::mars_boost::mp11::mp_bool<
#else
        typedef ::mars_boost::mpl::bool_<
            ...
            ) == sizeof(::mars_boost::parameter::aux::no_tag)
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        >;
#else
        > _has_unique_key;
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const&, ::mars_boost::mp11::mp_false) const
#else
            get_default(D const&, ::mars_boost::mpl::false_) const
#endif
        {
        ...
        inline BOOST_CONSTEXPR reference
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const& d, ::mars_boost::mp11::mp_true) const
#else
            get_default(D const& d, ::mars_boost::mpl::true_) const
#endif
        {
            return (
                this->arg.get_value()
     ...
     public:
        inline BOOST_CONSTEXPR reference
            operator[](::mars_boost::parameter::keyword<key_type> const&) const
        {
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::mars_boost::parameter::aux::default_<key_type,Default> const& d
            ) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::mars_boost::parameter::aux::default_r_<key_type,Default> const& d
            ) const
        {
            return this->get_default(d, _holds_maybe());
        }
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        static typename ::mars_boost::lazy_enable_if<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            ::mars_boost::mp11::mp_if<
                EmitsErrors
              ...
              , _has_unique_key
            >
          , ::mars_boost::parameter::aux::augment_predicate_mp11<
#else
            typename ::mars_boost::mpl::if_<
                EmitsErrors
        ...
        inline BOOST_CONSTEXPR ::mars_boost::parameter::aux::arg_list<
            ::mars_boost::parameter::aux::tagged_argument<KW,T2>
          , self
        >
            operator,(
                ::mars_boost::parameter::aux::tagged_argument<KW,T2> const& x
            ) const
        {
        ...
        template <typename KW, typename T2>
        inline BOOST_CONSTEXPR ::mars_boost::parameter::aux::arg_list<
            ::mars_boost::parameter::aux::tagged_argument_rref<KW,T2>
          , self
        >
            operator,(
                ::mars_boost::parameter::aux::tagged_argument_rref<KW,T2> const& x
            ) const
        {
            return ::mars_boost::parameter::aux::arg_list<
                ::mars_boost::parameter::aux::tagged_argument_rref<KW,T2>
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        ...
        struct key_owner
        {
            ...
            struct apply
            {
                typedef ::mars_boost::parameter::aux::empty_arg_list type;
            };
        };
    ...
    class arg_list : public Next
    {
     ...
     public:
        ...
        inline BOOST_CONSTEXPR arg_list(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(
              ...
              , ::mars_boost::parameter::aux::void_reference()
            )
          , arg(a0)
        {
        }
     ...
     public:
            ...
            struct apply
            {
                typedef typename ::mars_boost::mpl::eval_if<
                  ...
                  , ::mars_boost::mpl::identity<
                        ::mars_boost::parameter::aux::arg_list<TaggedArg,Next>
                    >
                  , ::mars_boost::mpl::apply_wrap1<next_key_owner,KW>
                >::type type;
            };
        };
        ...
        inline BOOST_CONSTEXPR typename ::mars_boost::mpl::apply_wrap3<
          ...
          , ::mars_boost::mpl::true_
        >::type
            operator[](::mars_boost::parameter::keyword<KW> const& x) const
        {
            typename ::mars_boost::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        // fails.
        inline BOOST_CONSTEXPR reference
            get(::mars_boost::parameter::keyword<key_type> const&) const
        {
            BOOST_MPL_ASSERT_NOT((_holds_maybe));
            return this->arg.get_value();
        }
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    struct arg_list_cons<>
    {
        using type = ::mars_boost::parameter::aux::empty_arg_list;
    };

    template <typename ArgTuple0, typename ...Tuples>
    struct arg_list_cons<ArgTuple0,Tuples...>
    {
        using type = ::mars_boost::parameter::aux::arg_list<
            typename ArgTuple0::tagged_arg
          , typename ::mars_boost::parameter::aux::arg_list_cons<Tuples...>::type
    ...
    class flat_like_arg_list
      : public ::mars_boost::parameter::aux::arg_list_cons<ArgTuples...>::type
    {
        using _base_type = typename ::mars_boost::parameter::aux
    ...
    template <>
    class flat_like_arg_list<>
      : public ::mars_boost::parameter::aux::empty_arg_list
    {
        using _base_type = ::mars_boost::parameter::aux::empty_arg_list;
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    {
        typedef ::mars_boost::mpl::forward_iterator_tag category;
    ...
    template <>
    struct arg_list_iterator< ::mars_boost::parameter::aux::empty_arg_list>
    {
    };
}}} // namespace mars_boost::parameter::aux
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace mpl {
    ...
    template <>
    struct begin_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
        template <typename S>
        struct apply
        {
            typedef ::mars_boost::parameter::aux::arg_list_iterator<S> type;
        };
    };

    template <>
    struct end_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
        template <typename>
        struct apply
        {
            typedef ::mars_boost::parameter::aux::arg_list_iterator<
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace mpl {
    ...
    template <>
    struct has_key_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace mpl {
    ...
    template <>
    struct count_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace mpl {
    ...
    template <>
    struct key_type_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace mpl {
    ...
    template <>
    struct value_type_impl< ::mars_boost::parameter::aux::arg_list_tag>
      : ::mars_boost::mpl::key_type_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace mars_boost::mpl
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace mpl {
    ...
    template <>
    struct at_impl< ::mars_boost::parameter::aux::arg_list_tag>
      : ::mars_boost::mpl::key_type_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace mars_boost::mpl
...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace mpl {
    ...
    template <>
    struct order_impl< ::mars_boost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::mars_boost::mpl::find<ArgList,Keyword>::type Itr;
            typedef typename ::mars_boost::mpl::eval_if<
                ::mars_boost::is_void<
                    typename ::mars_boost::parameter
                    ::value_type<ArgList,Keyword,void>::type
                >
              , ::mars_boost::mpl::identity< ::mars_boost::mpl::void_>
              , ::mars_boost::mpl::distance<
                    Itr
                  , ::mars_boost::parameter::aux::arg_list_iterator<
                        ::mars_boost::parameter::aux::empty_arg_list
                    >
                >
            >::type type;
