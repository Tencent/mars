...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using make_deduced_items = ::mars_boost::mp11::mp_if<
        ::std::is_same<Spec,::mars_boost::parameter::void_>
      , ::mars_boost::mp11::mp_identity< ::mars_boost::parameter::void_>
      , ::mars_boost::mp11::mp_if<
            ::mars_boost::parameter::aux::is_deduced<Spec>
          , ::mars_boost::parameter::aux::make_deduced_item<Spec,Tail>
          , Tail
        >
    >;
#else
    struct make_deduced_items
      : ::mars_boost::mpl::eval_if<
            ::mars_boost::is_same<Spec,::mars_boost::parameter::void_>
