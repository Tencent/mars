...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost { namespace parameter { namespace aux {
    ...
    {
        typedef ::mars_boost::parameter::aux::parameter_requirements<
            typename ::mars_boost::parameter::aux::tag_type<ParameterSpec>::type
          , typename ::mars_boost::parameter::aux::predicate<ParameterSpec>::type
          , ::mars_boost::parameter::aux::has_default<ParameterSpec>
        > type;
    };
